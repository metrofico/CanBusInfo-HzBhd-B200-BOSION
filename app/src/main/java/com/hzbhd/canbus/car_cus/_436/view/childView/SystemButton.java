...
public class SystemButton extends RelativeLayout {
    ...
    public SystemButton(Activity activity, String str, final PanoramaListener panoramaListener) {
        super(activity);
        View viewInflate = LayoutInflater.from(activity).inflate(R.layout._436_dialog_button_view, this);
        view = viewInflate;
        TextView textView = (TextView) viewInflate.findViewById(R.id.my_P_Key);
        this.my_P_Key = textView;
        textView.setText(str);
        this.my_P_Key.setOnClickListener(new View.OnClickListener() { // from class: com.hzbhd.canbus.car_cus._436.view.childView.SystemButton.1
