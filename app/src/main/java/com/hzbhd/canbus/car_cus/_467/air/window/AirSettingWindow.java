...
public class AirSettingWindow {
    ...
    private void intiView(final Context context) {
        View viewInflate = LayoutInflater.from(context).inflate(R.layout._467_window_settings, (ViewGroup) null);
        this.view = viewInflate;
        Button button = (Button) viewInflate.findViewById(R.id.ok);
        this.ok = button;
        button.setOnClickListener(new View.OnClickListener() { // from class: com.hzbhd.canbus.car_cus._467.air.window.AirSettingWindow.1
        ...
        this.mode1.setOnClickListener(new View.OnClickListener() { // from class: com.hzbhd.canbus.car_cus._467.air.window.AirSettingWindow.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.mode2.setOnClickListener(new View.OnClickListener() { // from class: com.hzbhd.canbus.car_cus._467.air.window.AirSettingWindow.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.cancel = button2;
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.hzbhd.canbus.car_cus._467.air.window.AirSettingWindow.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AirSettingWindow.this.hide();
            }
