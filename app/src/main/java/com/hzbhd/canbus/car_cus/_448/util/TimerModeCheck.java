...
public class TimerModeCheck {
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper()) { // from class: com.hzbhd.canbus.car_cus._448.util.TimerModeCheck.1
        ...
        public void handleMessage(Message message) {
            ...
            TimerModeCheck.this.thisActionDo.toDo(null);
        }
    };
