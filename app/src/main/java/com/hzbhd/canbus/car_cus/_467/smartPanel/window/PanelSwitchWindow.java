...
import com.hzbhd.R;
import com.hzbhd.canbus.car_cus._467.air.view.CheckItemView2;
...
public class PanelSwitchWindow {
    ...
    private void intiView(final Context context) {
        View viewInflate = LayoutInflater.from(context).inflate(R.layout._467_panel_switch_window, (ViewGroup) null);
        ...
        this.on_view.setOnClickListener(new View.OnClickListener() { // from class: com.hzbhd.canbus.car_cus._467.smartPanel.window.PanelSwitchWindow.1
        ...
        this.off_view.setOnClickListener(new View.OnClickListener() { // from class: com.hzbhd.canbus.car_cus._467.smartPanel.window.PanelSwitchWindow.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.cancel = button;
        button.setOnClickListener(new View.OnClickListener() { // from class: com.hzbhd.canbus.car_cus._467.smartPanel.window.PanelSwitchWindow.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                PanelSwitchWindow.this.hide();
            }
        });
        this.reset.setOnClickListener(new View.OnClickListener() { // from class: com.hzbhd.canbus.car_cus._467.smartPanel.window.PanelSwitchWindow.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (PanelSwitchWindow.this.on_view.isCheck()) {
                    Settings.System.putInt(BaseUtil.INSTANCE.getContext().getContentResolver(), "CAN_BUS_SMART_PANEL_PAGE_SWITCH_467", 1);
                } else {
                    Settings.System.putInt(BaseUtil.INSTANCE.getContext().getContentResolver(), "CAN_BUS_SMART_PANEL_PAGE_SWITCH_467", 0);
                }
                Context context2 = context;
                Toast.makeText(context2, context2.getString(R.string._439_panel_app5), 0).show();
                System.exit(0);
                PanelSwitchWindow.this.hide();
            }
        });
