package com.hzbhd.canbus.car_cus._439.drive.viiew;
...
public class DriveDateView extends RelativeLayout implements ActionDo {
    ...
    public DriveDateView(Context context, AttributeSet attributeSet, int i) {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(R.layout._439_view_repair, (ViewGroup) this, true);
        this.view = viewInflate;
        this.a2 = (TextView) viewInflate.findViewById(R.id.a2);
    ...
    private void updateUI() {
        BaseUtil.INSTANCE.runUi(new Function0<Unit>() { // from class: com.hzbhd.canbus.car_cus._439.drive.viiew.DriveDateView.1
