...
import com.hzbhd.canbus.car_cus._467.air.util.SharedTag;
...
public class AirView extends LinearLayout implements AirInfoObserver, View.OnClickListener {
    ...
    public AirView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mHandler = new Handler(Looper.getMainLooper()) { // from class: com.hzbhd.canbus.car_cus._467.air.view.AirView.9
        ...
        this.modeTag = 0;
        View viewInflate = LayoutInflater.from(context).inflate(R.layout._467_air_view1024x600, (ViewGroup) this, true);
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.hzbhd.canbus.car_cus._467.air.view.AirView.1
        ...
        this.setting_view.setOnClickListener(new View.OnClickListener() { // from class: com.hzbhd.canbus.car_cus._467.air.view.AirView.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AirView.this.resetTimer();
        ...
        airSettingView.getAction(new ActionCallback() { // from class: com.hzbhd.canbus.car_cus._467.air.view.AirView.3
    ...
    private void initTouchEvent() {
        this.win_up_img.setOnTouchListener(new View.OnTouchListener() { // from class: com.hzbhd.canbus.car_cus._467.air.view.AirView.4
        ...
        this.win_down_img.setOnTouchListener(new View.OnTouchListener() { // from class: com.hzbhd.canbus.car_cus._467.air.view.AirView.5
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                AirView.this.resetTimer();
                if (motionEvent.getAction() == 0) {
        ...
        this.temp_down.setOnTouchListener(new View.OnTouchListener() { // from class: com.hzbhd.canbus.car_cus._467.air.view.AirView.6
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                AirView.this.resetTimer();
                if (motionEvent.getAction() == 0) {
        ...
        this.temp_up.setOnTouchListener(new View.OnTouchListener() { // from class: com.hzbhd.canbus.car_cus._467.air.view.AirView.7
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                AirView.this.resetTimer();
                if (motionEvent.getAction() == 0) {
    ...
    public void resetTimer() {
        AirTimer.getInstance().start(AirData.exitTime, new ActionCallback() { // from class: com.hzbhd.canbus.car_cus._467.air.view.AirView.8
            @Override // com.hzbhd.canbus.car_cus._467.air.Interface.ActionCallback
            public void toDo(Object obj) {
