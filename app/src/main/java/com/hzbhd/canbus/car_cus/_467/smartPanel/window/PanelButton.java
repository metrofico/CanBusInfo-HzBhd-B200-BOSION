...
public class PanelButton extends RelativeLayout {
    ...
    public PanelButton(Context context, PanoramaListener panoramaListener) {
        super(context);
        this.showTag = false;
        this.listener = panoramaListener;
        view = LayoutInflater.from(context).inflate(R.layout._467_panel_window1024x600, this);
        ...
        this.wmParams.width = 108;
        this.wmParams.height = 108;
        this.wmParams.y = this.screenHeight - 108;
        this.wmParams.x = this.screenWidth - 108;
    }
