...
public class MainActivity extends AbstractBaseActivity implements MainLeftLvAdapter.LeftItemClickInterface {
    ...
    private Handler mHandler = new Handler() { // from class: com.hzbhd.canbus.car_cus._273.MainActivity.4
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout._273_activity_main);
        findViews();
        initViews();
    ...
    private void initViews() {
        ...
        new Thread() { // from class: com.hzbhd.canbus.car_cus._273.MainActivity.1
        ...
        new Thread() { // from class: com.hzbhd.canbus.car_cus._273.MainActivity.2
            @Override // java.lang.Thread, java.lang.Runnable
            public void run() {
        ...
        new Timer().schedule(new TimerTask() { // from class: com.hzbhd.canbus.car_cus._273.MainActivity.3
    ...
    @Override // com.hzbhd.canbus.car_cus._273.adapter.MainLeftLvAdapter.LeftItemClickInterface
    ...
    public void showViewByIndex(int i) {
        ...
        if (i == 2) {
            if (this.mMonitorView.getVisibility() == 8) {
                ...
                this.bgView.postDelayed(new Runnable() { // from class: com.hzbhd.canbus.car_cus._273.MainActivity.5
            ...
            this.bgView.setVisibility(0);
            this.bgView.postDelayed(new Runnable() { // from class: com.hzbhd.canbus.car_cus._273.MainActivity.6
                @Override // java.lang.Runnable
                public void run() {
                    MainActivity.this.bgView.setVisibility(8);
                }
