...
public class SpecialEqView extends RelativeLayout implements OnOffLvAdapter.ItemClickInterface, ViewInterface {
    ...
    public SpecialEqView(Context context, AttributeSet attributeSet) {
        ...
        this.mHandler = new Handler(Looper.getMainLooper()) { // from class: com.hzbhd.canbus.car_cus._290.view.SpecialEqView.1
    ...
    private void findViews() {
        ...
        this.mRlleft = (RelativeLayout) this.mView.findViewById(R.id.rl_left);
        this.mLlRight = (LinearLayout) this.mView.findViewById(R.id.ll_right);
    }
    ...
    @Override // com.hzbhd.canbus.car_cus._290.adapter.OnOffLvAdapter.ItemClickInterface
    ...
    */
    public void setSelectBtn(int r12, boolean r13) {
        ...
        L45:
            r2 = r9
        L46:
            com.hzbhd.canbus.car_cus._290.MessageSender.showCommonSwitch(r10, r2, r13)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hzbhd.canbus.car_cus._290.view.SpecialEqView.setSelectBtn(int, boolean):void");
    }
