...
public class CarSelectWindow {
    ...
    private void intiView(final Context context) {
        View viewInflate = LayoutInflater.from(context).inflate(R.layout._439_car_select, (ViewGroup) null);
        ...
        CheckItemView2 checkItemView23 = (CheckItemView2) this.view.findViewById(R.id.mode3);
