...
public class MainSettingActivity extends AbstractBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout._283_fragment_main_setting);
        initView();
    ...
    private void initView() {
        ...
        this.reverse_setting = (SettingView) findViewById(R.id.reverse_setting);
        ...
        this.sdv_esc.setOnItemClickListener(new SettingDialogView.OnItemClickListener() { // from class: com.hzbhd.canbus.car_cus._283.activity.MainSettingActivity$$ExternalSyntheticLambda0
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.reverse_setting /* 2131363140 */:
                startActivity(new Intent(this, (Class<?>) DyReverseSettingActivity.class));
                break;
    ...
    public void refreshUi(Bundle bundle) {
        ...
        int i = bundle.getInt("_283_CarSetting_what");
        this.mWhat = i;
        switch (i) {
            case 1:
                this.sdv_esc.setSelect(GeneralDzData.esc);
