...
public class OnStarActivity extends AbstractBaseActivity {
    ...
    private void findViews() {
        this.mFrameLayout = findViewById(R.id.fl_content);
    }
        ...
        try {
            switch (bundle.getInt(BUNDLE_ONSTAR_WHAT)) {
                ...
                case ON_STAR_NAVIGATION_WHAT:
                    ...
                    break;
                case ON_STAR_PHONE_MORE_INFO_WHAT:
    ...
    public void hide() {
        this.mOnStartPhoneFragment.dialog.setVisibility(View.INVISIBLE);
        this.mOnStartPhoneFragment.input.setVisibility(View.INVISIBLE);
    }
