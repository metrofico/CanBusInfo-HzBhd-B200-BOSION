...
public class SelectIdActivity extends Activity implements View.OnClickListener {
    ...
    private SelectCanTypeIdAdapter.ItemCallBackInterface mCarModelClick = new SelectCanTypeIdAdapter.ItemCallBackInterface() { // from class: com.hzbhd.canbus.activity.SelectIdActivity.1
    ...
    private void initViews() {
        ...
        this.mListRv.setLayoutManager(new GridLayoutManager((Context) this, 6, 1, false));
