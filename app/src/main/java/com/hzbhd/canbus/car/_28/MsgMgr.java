...
public class MsgMgr extends AbstractMsgMgr {
    ...
    public void discInfoChange(byte b, int i, int i2, int i3, int i4, int i5, int i6, boolean z, boolean z2, int i7, String str, String str2, String str3) {
        ...
        int[] time = this.getTime(i);
        sendMediaMessage(SourceConstantsDef.SOURCE_ID.MPEG.ordinal(), DataHandleUtils.byteMerger(new byte[]{22, -46, (byte) i8}, (Integer.toString(DataHandleUtils.rangeNumber(getTime(i)[0], 0, 9)) + this.mDecimalFormat00.format(time[1]) + this.mDecimalFormat00.format(time[2]) + this.mDecimalFormat0000.format(i3) + "   ").getBytes()));
    }
