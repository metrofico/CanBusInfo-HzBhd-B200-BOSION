...
public class UiMgr extends AbstractUiMgr {
    ...
    public UiMgr(final Context context) {
        ...
        originalCarDevicePageUiSet.setOnOriginalCarDevicePageStatusListener(new OnOriginalCarDevicePageStatusListener() { // from class: com.hzbhd.canbus.car._48.UiMgr.1
        ...
        originalCarDevicePageUiSet.setOnOriginalSongItemClickListener(new OnOriginalSongItemClickListener() { // from class: com.hzbhd.canbus.car._48.UiMgr.2
        ...
        originalCarDevicePageUiSet.setOnOriginalTopBtnClickListeners(new OnOriginalTopBtnClickListener() { // from class: com.hzbhd.canbus.car._48.UiMgr.3
            ...
            public void onClickTopBtnItem(int i) {
                ...
                switch (str) {
                    ...
                    case "aux":
                        ...
                        UiMgr.this.getMsgMgr(context).onAuxClick();
                        break;
                    case "scan":
        ...
        originalCarDevicePageUiSet.setOnOriginalBottomBtnClickListeners(new OnOriginalBottomBtnClickListener() { // from class: com.hzbhd.canbus.car._48.UiMgr.4
        ...
        originalCarDevicePageUiSet.setOnOriginalCarDeviceBackPressedListener(new OnOriginalCarDeviceBackPressedListener() { // from class: com.hzbhd.canbus.car._48.UiMgr.5
        ...
        settingUiSet.setOnSettingPageStatusListener(new OnSettingPageStatusListener() { // from class: com.hzbhd.canbus.car._48.UiMgr.6
            @Override // com.hzbhd.canbus.interfaces.OnSettingPageStatusListener
            public void onStatusChange(int i) {
                if (i == -1) {
                    UiMgr.this.getTimerUtil().startTimer(new TimerTask() { // from class: com.hzbhd.canbus.car._48.UiMgr.6.1
                        int[] dataTypeArray = {50, 211, NfDef.STATE_3WAY_INCOMING_CALL_S_ACT_S_HOLD};
                        int i = 0;

                        @Override // java.util.TimerTask, java.lang.Runnable
                        public void run() {
                            int i2 = this.i;
                            int[] iArr = this.dataTypeArray;
                            if (i2 >= iArr.length) {
        ...
        settingUiSet.setOnSettingItemClickListener(new OnSettingItemClickListener() { // from class: com.hzbhd.canbus.car._48.UiMgr.7
            ...
            public void onClickItem(int i, int i2) {
                ...
                if (titleSrn.equals("compass_run_calibration")) {
                    CanbusMsgSender.sendMsg(new byte[]{22, -58, 96, (byte) (1 ^ (UiMgr.this.getMsgMgr(context).mCalibrationStatus ? 1 : 0))});
                }
            }
        });
        settingUiSet.setOnSettingItemSeekbarSelectListener(new OnSettingItemSeekbarSelectListener() { // from class: com.hzbhd.canbus.car._48.UiMgr.8
        ...
        settingUiSet.setOnSettingConfirmDialogListener(new OnConfirmDialogListener() { // from class: com.hzbhd.canbus.car._48.UiMgr.9
            ...
            public void onConfirmClick(int i, int i2) {
                ...
                switch (titleSrn) {
                    ...
                    case "front_camera_switch":
                        SharePreUtil.setBoolValue(context, UiMgr.SHARE_48_FRONT_CAMERA_SWITCH, !SharePreUtil.getBoolValue(context, UiMgr.SHARE_48_FRONT_CAMERA_SWITCH, false));
                        break;
                    case "_55_0x6E_0x06":
        ...
        settingUiSet.setOnSettingItemSelectListener(new OnSettingItemSelectListener() { // from class: com.hzbhd.canbus.car._48.UiMgr.10
            ...
            public void onClickItem(int i, int i2, int i3) {
                ...
                switch (titleSrn) {
                    ...
                    case "_55_0x65_data1_bit76":
                        ...
                        break;
                    case "_48_forward_collision_warning_distance":
                    ...
                    case "_209_32_3_7":
                        ...
                        break;
                    case "_48_bsm_reference_line":
                        CanbusMsgSender.sendMsg(new byte[]{22, -58, 80, (byte) i3});
                        UiMgr.this.getMsgMgr(context).updateSetttings(i, i2, i3);
                        break;
                    case "_48_memory_position_link":
        ...
        driverDataPageUiSet.setOnDriveDataPageStatusListener(new OnDriveDataPageStatusListener() { // from class: com.hzbhd.canbus.car._48.UiMgr.11
        ...
        getParkPageUiSet(context).setOnPanoramicItemClickListener(new OnPanoramicItemClickListener() { // from class: com.hzbhd.canbus.car._48.UiMgr.12
