    ...
    */
    public void radioInfoChange(int r6, java.lang.String r7, java.lang.String r8, java.lang.String r9, int r10) {
        ...
        L5e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hzbhd.canbus.car._101.MsgMgr.radioInfoChange(int, java.lang.String, java.lang.String, java.lang.String, int):void");
    }
    ...
    public void currentVolumeInfoChange(int i, boolean z) {
        ...
        this.mMediaInfoData6 = DataHandleUtils.setIntByteWithBit(this.mMediaInfoData6, 3, z);
    }
    ...
    public void btPhoneStatusInfoChange(int i, byte[] bArr, boolean z, boolean z2, boolean z3, boolean z4, int i2, int i3, Bundle bundle) {
        ...
        this.mMediaInfoData6 = DataHandleUtils.setIntByteWithBit(this.mMediaInfoData6, 2, z);
    }
