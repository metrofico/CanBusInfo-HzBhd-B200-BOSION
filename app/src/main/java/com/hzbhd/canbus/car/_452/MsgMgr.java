...
public class MsgMgr extends AbstractMsgMgr {
    ...
    private void registerAux2() {
        SourceManager.getInstance().registerSourceListener(SourceConstantsDef.SOURCE_ID.AUX2, SourceConstantsDef.DISP_ID.disp_main, new ISourceListener() { // from class: com.hzbhd.canbus.car._452.MsgMgr.1
    ...
    public void reverseStateChange(boolean z) {
        ...
        if (z) {
            CycleRequestRadar.getInstance().start(10, new ActionCallback() { // from class: com.hzbhd.canbus.car._452.MsgMgr.2
    ...
    public void canbusInfoChange(Context context, byte[] bArr) {
        ...
        if (i == 37) {
            setAir0x25(byteArrayToIntArray);
            return;
        }
        if (i == 48) {
    ...
    private void setAir0x25(int[] iArr) {
        if (isAirDataChange(iArr)) {
            ...
            if (!DataHandleUtils.getBoolBit7(iArr[8]) && !DataHandleUtils.getBoolBit6(iArr[8])) {
                GeneralAirData.auto = DataHandleUtils.getBoolBit2(iArr[2]);
            }
            ...
            GeneralAirData.max_front = DataHandleUtils.getBoolBit7(iArr[3]);
            GeneralAirData.dual = DataHandleUtils.getBoolBit6(iArr[3]);
            GeneralAirData.front_left_blow_window = DataHandleUtils.getBoolBit7(iArr[4]);
            GeneralAirData.front_left_blow_head = DataHandleUtils.getBoolBit6(iArr[4]);
            GeneralAirData.front_left_blow_foot = DataHandleUtils.getBoolBit5(iArr[4]);
            GeneralAirData.front_right_blow_window = DataHandleUtils.getBoolBit7(iArr[4]);
            GeneralAirData.front_right_blow_head = DataHandleUtils.getBoolBit6(iArr[4]);
            GeneralAirData.front_right_blow_foot = DataHandleUtils.getBoolBit5(iArr[4]);
            ...
            if (i == 0) {
                ...
                GeneralAirData.front_left_temperature = this.df_1Decimal.format(iArr[5] / 2.0f) + getTempUnitC(this.mContext);
            }
            int i2 = iArr[6];
            if (i2 == 0) {
                ...
                GeneralAirData.front_right_temperature = this.df_1Decimal.format(iArr[6] / 2.0f) + getTempUnitC(this.mContext);
            }
