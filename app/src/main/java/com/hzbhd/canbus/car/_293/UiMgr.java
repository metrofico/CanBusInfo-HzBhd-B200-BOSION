...
public class UiMgr extends AbstractUiMgr {
    ...
    private OnAirBtnClickListener mTop = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._293.UiMgr.1
    ...
    private OnAirBtnClickListener mLeft = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._293.UiMgr.2
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
    ...
    private OnAirBtnClickListener mRight = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._293.UiMgr.3
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            if (((CanSettingProxy) Dependency.get(CanSettingProxy.class)).getSwitchAcTemperature()) {
                UiMgr.this.senAirMsg(11);
    ...
    private OnAirBtnClickListener mBottom = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._293.UiMgr.4
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            if (i == 0) {
    ...
    private OnAirTemperatureUpDownClickListener mLeftTem = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._293.UiMgr.5
    ...
    private OnAirTemperatureUpDownClickListener mRightTem = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._293.UiMgr.6
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirTemperatureUpDownClickListener
        public void onClickUp() {
    ...
    private OnAirWindSpeedUpDownClickListener mWindLv = new OnAirWindSpeedUpDownClickListener() { // from class: com.hzbhd.canbus.car._293.UiMgr.7
    ...
    private OnAmplifierPositionListener mPosition = new OnAmplifierPositionListener() { // from class: com.hzbhd.canbus.car._293.UiMgr.8
    ...
    private OnAmplifierSeekBarListener mSeekBar = new OnAmplifierSeekBarListener() { // from class: com.hzbhd.canbus.car._293.UiMgr.9
    ...
    private OnSettingItemSeekbarSelectListener seekBar = new OnSettingItemSeekbarSelectListener() { // from class: com.hzbhd.canbus.car._293.UiMgr.10
    ...
    /* renamed from: com.hzbhd.canbus.car._293.UiMgr$11, reason: invalid class name */
