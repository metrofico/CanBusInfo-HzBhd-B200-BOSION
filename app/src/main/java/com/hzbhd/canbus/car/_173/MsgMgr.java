...
public class MsgMgr extends AbstractMsgMgr {
    ...
    private void setPanoramicStatus() {
        ...
        SharePreUtil.setBoolValue(this.mContext, _173_IS_BACK_CAMERA, intFromByteWithBit == 1);
        SharePreUtil.setBoolValue(this.mContext, _173_IS_PANORAMIC, intFromByteWithBit == 2);
        ...
        } else if (SharePreUtil.getBoolValue(this.mContext, _173_IS_PANORAMIC, false)) {
            int i2 = 5;
            while (i2 <= 8) {
    ...
    */
    private void setTypeDataInfo() {
        ...
        L48:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hzbhd.canbus.car._173.MsgMgr.setTypeDataInfo():void");
    }
    ...
    void setLanguage_recNull(Context context) {
        int intValue = SharePreUtil.getIntValue(context, "_173_SAVE_LANGUAGE", 0);
        ArrayList arrayList = new ArrayList();
    ...
    private boolean isOnlyDoorMsgShow() {
        return (SharePreUtil.getBoolValue(this.mContext, "_173_isleft_front_door_open", false) == GeneralDoorData.isLeftFrontDoorOpen && SharePreUtil.getBoolValue(this.mContext, "_173_isright_front_door_open", false) == GeneralDoorData.isRightFrontDoorOpen && SharePreUtil.getBoolValue(this.mContext, "_173_isright_rear_door_open", false) == GeneralDoorData.isRightRearDoorOpen && SharePreUtil.getBoolValue(this.mContext, "_173_isleft_rear_door_open", false) == GeneralDoorData.isLeftRearDoorOpen && SharePreUtil.getBoolValue(this.mContext, "_173_isback_open", false) == GeneralDoorData.isBackOpen) ? false : true;
    }

    private boolean isOnlyRearUpdate() {
        return (SharePreUtil.getIntValue(this.mContext, "_173_air_rear", 0) == this.isOnlyRearUpdate && SharePreUtil.getIntValue(this.mContext, "_173_air_rear_temp", 0) == this.isOnlyRearTempDate) ? false : true;
    }
    ...
    void initAmplifierData(Context context) {
        GeneralAmplifierData.frontRear = 10 - SharePreUtil.getIntValue(context, "_173_amplifier_fade", 0);
        GeneralAmplifierData.leftRight = SharePreUtil.getIntValue(context, "_173_amplifier_balance", 0) - 10;
        GeneralAmplifierData.bandBass = SharePreUtil.getIntValue(context, "_173_amplifier_bass", 0) - 10;
        GeneralAmplifierData.bandMiddle = SharePreUtil.getIntValue(context, "_173_amplifier_middle", 0) - 10;
        GeneralAmplifierData.bandTreble = SharePreUtil.getIntValue(context, "_173_amplifier_treble", 0) - 10;
