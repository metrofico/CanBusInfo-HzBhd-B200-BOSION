...
public class UiMgr extends AbstractUiMgr {
    protected static final String CAN_162_LOUD = "CAN_162_LOUD";
    protected static final String CAN_162_SAVE_AMP_BASS = "__162_SAVE_AMP_BASS";
    protected static final String CAN_162_SAVE_AMP_FR = "__162_SAVE_AMP_FR";
    protected static final String CAN_162_SAVE_AMP_LR = "__162_SAVE_AMP_LR";
    protected static final String CAN_162_SAVE_AMP_MID = "__162_SAVE_AMP_MID";
    protected static final String CAN_162_SAVE_AMP_TRE = "__162_SAVE_AMP_TRE";
    protected static final String CAN_162_SAVE_AMP_VOL = "__162_SAVE_AMP_VOL";
    protected static final String CAN_162_SAVE_AMP__HEAVY_BASS = "__162_SAVE_AMP_HEAVY_BASS";
    protected static final String CAN_162_SAVE_IS_AMP_FIRST = "CAN_162_SAVE_IS_AMP_FIRST";
    ...
    private OnAirBtnClickListener mOnAirBtnClickListenerLeft = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.26
    ...
    private OnAirBtnClickListener mOnAirBtnClickListenerBottom = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.27
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            if (i == 0) {
    ...
    OnAirTemperatureUpDownClickListener onUpDownClickListenerLeft = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.29
    ...
    OnAirTemperatureUpDownClickListener onUpDownClickListenerCenter = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.30
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirTemperatureUpDownClickListener
        public void onClickDown() {
        }
    ...
    OnAirTemperatureUpDownClickListener onUpDownClickListenerRight = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.31
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirTemperatureUpDownClickListener
        public void onClickUp() {
    ...
    OnAirBtnClickListener mOnAirBtnClickListenerRearBottom = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.32
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
        }
    };
    ...
    public void updateUiByDifferentCar(Context context) {
        ...
        Log.i("ljq", "updateUiByDifferentCar: " + this.mDifferentId);
    ...
    public UiMgr(final Context context) {
        ...
        Log.i("ljqde", "init UiMgr: ");
        this.msgMgr = (MsgMgr) MsgMgrFactory.getCanMsgMgr(context);
        this.mDifferentId = getCurrentCarId();
        initSetting(context);
        Log.i("ljqde", "UiMgr: " + this.mDifferentId);
        final SettingPageUiSet settingUiSet = getSettingUiSet(context);
        settingUiSet.setOnSettingItemSeekbarSelectListener(new OnSettingItemSeekbarSelectListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.1
        ...
        settingUiSet.setOnSettingItemClickListener(new OnSettingItemClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.2
            @Override // com.hzbhd.canbus.interfaces.OnSettingItemClickListener
            public void onClickItem(int i, int i2) {
                Objects.requireNonNull(settingUiSet.getList().get(i).getItemList().get(i2).getTitleSrn());
            }
        });
        settingUiSet.setOnSettingConfirmDialogListener(new OnConfirmDialogListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.3
        ...
        settingUiSet.setOnSettingItemSelectListener(new OnSettingItemSelectListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.4
        ...
        getParkPageUiSet(context).setOnPanoramicItemClickListener(new OnPanoramicItemClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.5
        ...
        airUiSet.getFrontArea().setOnAirBtnClickListeners(new OnAirBtnClickListener[]{new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.6
            ...
            */
            public void onClickItem(int r5) {
                ...
                L57:
                    goto L79
                L58:
                    com.hzbhd.canbus.car._219.UiMgr r0 = com.hzbhd.canbus.car._219.UiMgr.this
                    com.hzbhd.canbus.car._219.UiMgr.access$200(r0, r5)
                    goto L79
                L5e:
                    com.hzbhd.canbus.car._219.UiMgr r5 = com.hzbhd.canbus.car._219.UiMgr.this
                    com.hzbhd.canbus.car._219.UiMgr.access$200(r5, r2)
                    goto L79
                L64:
                    com.hzbhd.canbus.car._219.UiMgr r5 = com.hzbhd.canbus.car._219.UiMgr.this
                    r0 = 16
                    com.hzbhd.canbus.car._219.UiMgr.access$200(r5, r0)
                    goto L79
                L6c:
                    com.hzbhd.canbus.car._219.UiMgr r5 = com.hzbhd.canbus.car._219.UiMgr.this
                    r0 = 21
                ...
                L79:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.hzbhd.canbus.car._219.UiMgr.AnonymousClass6.onClickItem(int):void");
            }
        }, new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.7
            @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
            public void onClickItem(int i) {
        ...
        }, new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.8
            @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
            public void onClickItem(int i) {
        ...
        }, new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.9
            /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
            /* JADX WARN: Failed to restore switch over string. Please report as a decompilation issue */
            /* JADX WARN: Removed duplicated region for block: B:4:0x001b  */
            @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
            ...
            */
            public void onClickItem(int r5) {
                ...
                Laa:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.hzbhd.canbus.car._219.UiMgr.AnonymousClass9.onClickItem(int):void");
            }
        }});
        airUiSet.getFrontArea().setSetWindSpeedViewOnClickListener(new OnAirWindSpeedUpDownClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.10
        ...
        airUiSet.getFrontArea().setSeatHeatColdClickListeners(new OnAirSeatHeatColdMinPlusClickListener[]{new OnAirSeatHeatColdMinPlusClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.11
        ...
        }, new OnAirSeatHeatColdMinPlusClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.12
            @Override // com.hzbhd.canbus.adapter.interfaces.OnAirSeatHeatColdMinPlusClickListener
            public void onClickMin() {
            }
        ...
        }, new OnAirSeatHeatColdMinPlusClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.13
            @Override // com.hzbhd.canbus.adapter.interfaces.OnAirSeatHeatColdMinPlusClickListener
            public void onClickMin() {
            }
        ...
        }, new OnAirSeatHeatColdMinPlusClickListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.14
            @Override // com.hzbhd.canbus.adapter.interfaces.OnAirSeatHeatColdMinPlusClickListener
            public void onClickMin() {
            }
        ...
        amplifierPageUiSet.setOnAmplifierSeekBarListener(new OnAmplifierSeekBarListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.15
            @Override // com.hzbhd.canbus.interfaces.OnAmplifierSeekBarListener
            public void progress(AmplifierActivity.AmplifierBand amplifierBand, int i) {
                int i2 = AnonymousClass33.$SwitchMap$com$hzbhd$canbus$activity$AmplifierActivity$AmplifierBand[amplifierBand.ordinal()];
                if (i2 == 1) {
                    UiMgr.this.mIsClickReset = false;
                    SharePreUtil.setIntValue(UiMgr.this.mContext, UiMgr.CAN_162_SAVE_AMP_BASS, i);
                    GeneralAmplifierData.bandBass = i;
                    UiMgr.this.isEightNumer();
                    UiMgr.this.setAmpParams();
                    return;
                }
                if (i2 == 2) {
                    UiMgr.this.mIsClickReset = false;
                    SharePreUtil.setIntValue(UiMgr.this.mContext, UiMgr.CAN_162_SAVE_AMP_TRE, i);
                ...
                UiMgr.this.mIsClickReset = false;
                SharePreUtil.setIntValue(UiMgr.this.mContext, UiMgr.CAN_162_SAVE_AMP_VOL, i);
                GeneralAmplifierData.volume = i;
                UiMgr.this.sendAmpKeyMsg(15, i);
            }
        });
        amplifierPageUiSet.setOnAmplifierPositionListener(new OnAmplifierPositionListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.16
            @Override // com.hzbhd.canbus.interfaces.OnAmplifierPositionListener
            public void position(AmplifierActivity.AmplifierPosition amplifierPosition, int i) {
                int i2 = AnonymousClass33.$SwitchMap$com$hzbhd$canbus$activity$AmplifierActivity$AmplifierPosition[amplifierPosition.ordinal()];
                if (i2 == 1) {
                    if (UiMgr.this.mIsClickReset) {
                        return;
                    }
                    SharePreUtil.setIntValue(UiMgr.this.mContext, UiMgr.CAN_162_SAVE_AMP_FR, i);
                ...
                SharePreUtil.setIntValue(UiMgr.this.mContext, UiMgr.CAN_162_SAVE_AMP_LR, i);
                GeneralAmplifierData.leftRight = i;
                UiMgr.this.isEightNumer();
                UiMgr.this.setAmpParams();
            }
        });
        amplifierPageUiSet.setOnAmplifierResetPositionListener(new OnAmplifierResetPositionListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.17
        ...
        panelKeyPageUiSet.setOnPanelKeyPositionListener(new OnPanelKeyPositionListener() { // from class: com.hzbhd.canbus.car._219.UiMgr.18
            @Override // com.hzbhd.canbus.interfaces.OnPanelKeyPositionListener
            public void click(int i) {
                Log.d("mww panelKeyPageUiSet", panelKeyPageUiSet.getList().get(i));
                String str = panelKeyPageUiSet.getList().get(i);
                str.hashCode();
                switch (str) {
                    case "OPEL_KEY_Right":
                        UiMgr.this.sendKey2Msg(32);
                        break;
                    case "OPEL_KEY_Dark":
                        UiMgr.this.sendKey2Msg(128);
                        break;
                    case "OPEL_KEY_Down":
                        UiMgr.this.sendKey2Msg(8);
                        break;
                    case "OPEL_KEY_Left":
                        UiMgr.this.sendKey2Msg(16);
                        break;
                    case "OPEL_KEY_Loud":
                        boolean z = !SharePreUtil.getBoolValue(UiMgr.this.mContext, UiMgr.CAN_162_LOUD, false);
                        SharePreUtil.setBoolValue(UiMgr.this.mContext, UiMgr.CAN_162_LOUD, z);
                        UiMgr.this.sendAmpKeyMsg(17, z ? 1 : 0);
                        break;
                    case "OPEL_KEY_Menu":
                        UiMgr.this.sendKey2Msg(1);
                        break;
                    case "OPEL_KEY_Mode":
                        UiMgr.this.sendKey2Msg(64);
                        break;
                    case "OPEL_KEY_OK":
                        UiMgr.this.sendKey1Msg(32);
                        break;
                    case "OPEL_KEY_Up":
                        UiMgr.this.sendKey2Msg(4);
                        break;
                    case "OPEL_KEY_ESC":
                        UiMgr.this.sendKey2Msg(2);
                        break;
                }
            }
        });
    ...
    /* renamed from: com.hzbhd.canbus.car._219.UiMgr$33, reason: invalid class name */
    ...
    public void setAmpParams() {
        CanbusMsgSender.sendMsg(new byte[]{22, 9, 19, (byte) GeneralAmplifierData.bandBass, (byte) (GeneralAmplifierData.frontRear + 7), (byte) (GeneralAmplifierData.leftRight + 7), (byte) GeneralAmplifierData.bandTreble, 0});
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void sendAirKeyMsg(final int i) {
        this.mHandler.postDelayed(new Runnable() { // from class: com.hzbhd.canbus.car._219.UiMgr.19
            @Override // java.lang.Runnable
            public void run() {
                CanbusMsgSender.sendMsg(new byte[]{22, 8, (byte) i, 1});
            }
        }, 30L);
        this.mHandler.postDelayed(new Runnable() { // from class: com.hzbhd.canbus.car._219.UiMgr.20
            @Override // java.lang.Runnable
            public void run() {
                CanbusMsgSender.sendMsg(new byte[]{22, 8, (byte) i, 0});
            }
        }, 30L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void sendKey2Msg(final int i) {
        this.mHandler.postDelayed(new Runnable() { // from class: com.hzbhd.canbus.car._219.UiMgr.21
            @Override // java.lang.Runnable
            public void run() {
                CanbusMsgSender.sendMsg(new byte[]{22, 8, 0, (byte) i});
            }
        }, 30L);
        this.mHandler.postDelayed(new Runnable() { // from class: com.hzbhd.canbus.car._219.UiMgr.22
            @Override // java.lang.Runnable
            public void run() {
                CanbusMsgSender.sendMsg(new byte[]{22, 8, 0, 0});
            }
        }, 30L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void sendKey1Msg(int i) {
        this.mHandler.postDelayed(new Runnable() { // from class: com.hzbhd.canbus.car._219.UiMgr.23
            @Override // java.lang.Runnable
            public void run() {
                CanbusMsgSender.sendMsg(new byte[]{22, 8, 32, 0});
            }
        }, 30L);
        this.mHandler.postDelayed(new Runnable() { // from class: com.hzbhd.canbus.car._219.UiMgr.24
            @Override // java.lang.Runnable
            public void run() {
                CanbusMsgSender.sendMsg(new byte[]{22, 8, 0, 0});
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void sendAmpKeyMsg(final int i, final int i2) {
        this.mHandler.postDelayed(new Runnable() { // from class: com.hzbhd.canbus.car._219.UiMgr.25
            @Override // java.lang.Runnable
            public void run() {
                CanbusMsgSender.sendMsg(new byte[]{22, 9, (byte) i, (byte) i2});
            }
        }, 30L);
    }
    ...
    private void requestCommand() {
        ...
        getSettingTimerUtil().startTimer(new TimerTask() { // from class: com.hzbhd.canbus.car._219.UiMgr.28
            int i = 0;
