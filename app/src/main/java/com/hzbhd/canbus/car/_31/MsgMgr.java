...
public class MsgMgr extends AbstractMsgMgr {
    ...
    public void afterServiceNormalSetting(Context context) {
        ...
        new TimerUtil().startTimer(new TimerTask() { // from class: com.hzbhd.canbus.car._31.MsgMgr.1
            @Override // java.util.TimerTask, java.lang.Runnable
            public void run() {
                MsgMgr msgMgr = MsgMgr.this;
                msgMgr.sndSimpleVol((byte) 35, (byte) msgMgr.mVolume, MsgMgr.this.mVolume == 0);
            }
        }, 2000L, 1000L);
    }
    ...
    public void initCommand(Context context) {
        ...
        getUiMgr(context).sendAmplifierCommand(true);
    }
    ...
    public void onAccOff() {
        ...
        Context context = this.mContext;
        if (context != null) {
            getUiMgr(context).sendAmplifierCommand(false);
        }
    }
                ...
                default:
                    switch (i) {
                        ...
                        default:
                            switch (i) {
                                case 129:
                                    realKeyClick3(this.mContext, 7, i, iArr[3]);
                                    break;
                                case 130:
                                    realKeyClick3(this.mContext, 8, i, iArr[3]);
                                    break;
                                case 131:
                                    realKeyLongClick1(this.mContext, 45, iArr[3]);
                                    break;
    ...
    private void setPanoramicStatus() {
        ...
        SharePreUtil.setBoolValue(this.mContext, _31_IS_BACK_CAMERA, intFromByteWithBit == 1);
        SharePreUtil.setBoolValue(this.mContext, _31_IS_PANORAMIC, intFromByteWithBit == 2);
        ...
        } else if (SharePreUtil.getBoolValue(this.mContext, _31_IS_PANORAMIC, false)) {
            int i2 = 5;
            while (i2 <= 8) {
    ...
    private void setAirData0x21() {
        ...
        if (is0x21DataChange()) {
            ...
            if (this.mCanBusInfoByte.length > 8) {
                GeneralAirData.rear_temperature = resolveLeftAndRightAutoTemp(this.mCanBusInfoInt[8]);
            }
    ...
    private boolean is0x21DataChange() {
        ...
        int[] iArr = this.mCanBusInfoInt;
        this.m0x21Data = Arrays.copyOf(iArr, iArr.length);
        return true;
    }

    private int getAirWhat() {
        int[] iArr = this.mCanBusInfoInt;
        int[] iArr2 = {iArr[2], iArr[3], iArr[4], iArr[5], iArr[6]};
        int[] iArr3 = new int[2];
        iArr3[0] = iArr[7];
        if (iArr.length > 8) {
            iArr3[1] = iArr[8];
        ...
        if (!Arrays.equals(this.mAirFrontData, iArr2)) {
            this.mAirFrontData = Arrays.copyOf(iArr2, 5);
            return 1001;
        }
        if (Arrays.equals(this.mAirRearData, iArr3)) {
            return 0;
        }
        this.mAirRearData = Arrays.copyOf(iArr3, 2);
        return 1002;
    }
    ...
    public void setAmplifier(int i, int i2) {
        ...
        GeneralAmplifierData.leftRight = i2;
    ...
    */
    private void setTypeDataInfo() {
        ...
        L48:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hzbhd.canbus.car._31.MsgMgr.setTypeDataInfo():void");
    }
    ...
    void setLanguage_recNull(Context context) {
        int intValue = SharePreUtil.getIntValue(context, "_31_SAVE_LANGUAGE", 0);
        ArrayList arrayList = new ArrayList();
    ...
    public void sndSimpleVol(byte b, byte b2, boolean z) {
        if (b >= 40) {
            b = 40;
        }
        if (b2 >= b) {
    ...
    private boolean isOnlyDoorMsgShow() {
        return (SharePreUtil.getBoolValue(this.mContext, "_31_isleft_front_door_open", false) == GeneralDoorData.isLeftFrontDoorOpen && SharePreUtil.getBoolValue(this.mContext, "_31_isright_front_door_open", false) == GeneralDoorData.isRightFrontDoorOpen && SharePreUtil.getBoolValue(this.mContext, "_31_isright_rear_door_open", false) == GeneralDoorData.isRightRearDoorOpen && SharePreUtil.getBoolValue(this.mContext, "_31_isleft_rear_door_open", false) == GeneralDoorData.isLeftRearDoorOpen && SharePreUtil.getBoolValue(this.mContext, "_31_isback_open", false) == GeneralDoorData.isBackOpen) ? false : true;
    }

    private boolean isOnlyRearUpdate() {
        return (SharePreUtil.getIntValue(this.mContext, "_31_air_rear", 0) == this.isOnlyRearUpdate && SharePreUtil.getIntValue(this.mContext, "_31_air_rear_temp", 0) == this.isOnlyRearTempDate) ? false : true;
    }
    ...
    private void initAmplifierData(Context context) {
        ...
        final int i = 10 - GeneralAmplifierData.frontRear;
        final int i2 = GeneralAmplifierData.leftRight + 10;
        final int i3 = GeneralAmplifierData.bandTreble;
        final int i4 = GeneralAmplifierData.bandMiddle;
        final int i5 = GeneralAmplifierData.bandBass;
        Log.i("_31_MsgMgr", "initAmplifierData: send");
        new TimerUtil().startTimer(new TimerTask() { // from class: com.hzbhd.canbus.car._31.MsgMgr.2
            @Override // java.util.TimerTask, java.lang.Runnable
            public void run() {
                CanbusMsgSender.sendMsg(new byte[]{22, -57, 0, (byte) i, (byte) i2, (byte) i3, (byte) i4, (byte) i5});
            }
        }, 1000L);
    }
