...
public class MsgMgr extends AbstractMsgMgr {
    ...
    public void discInfoChange(byte b, int i, int i2, int i3, int i4, int i5, int i6, boolean z, boolean z2, int i7, String str, String str2, String str3) {
        ...
        getUiMgr(this.mContext).sendSourceInfo(2, 16, i4, i5, 0, 0, 0, 0);
        sendUSBInfo(str, str3);
    }
    ...
    public void btPhoneStatusInfoChange(int i, byte[] bArr, boolean z, boolean z2, boolean z3, boolean z4, int i2, int i3, Bundle bundle) {
        ...
        getUiMgr(this.mContext).sendSourceInfo(5, 64, 0, 0, 0, 0, 0, 0);
    ...
    public void auxInInfoChange() {
        ...
        getUiMgr(this.mContext).sendSourceInfo(7, 48, 0, 0, 0, 0, 0, 0);
    }
    ...
    public void auxInDestdroy() {
        ...
        getUiMgr(this.mContext).sendSourceInfo(0, 0, 0, 0, 0, 0, 0, 0);
    }
    ...
    public void musicInfoChange(byte b, byte b2, int i, int i2, byte b3, byte b4, byte b5, byte b6, byte b7, byte b8, String str, String str2, String str3, long j, byte b9, int i3, boolean z, long j2, String str4, String str5, String str6, boolean z2) {
        ...
        int i4 = i3 + 1;
        getUiMgr(this.mContext).sendSourceInfo(8, 19, getLsb(i4), getMsb(i4), getLsb(i2), getMsb(i2), 0, 0);
        sendUSBInfo(str4, str6);
    }
    ...
    public void videoInfoChange(byte b, byte b2, int i, int i2, byte b3, byte b4, byte b5, String str, byte b6, byte b7, String str2, String str3, String str4, int i3, byte b8, boolean z, int i4) {
        ...
        getUiMgr(this.mContext).sendSourceInfo(8, 19, i, b6, getLsb(i2), getMsb(i2), 0, 0);
    }
    ...
    public void currentVolumeInfoChange(int i, boolean z) {
        ...
        getUiMgr(this.mContext).sendVolInfo(this.volInfoData0);
    }
    ...
    public void radioInfoChange(int i, String str, String str2, String str3, int i2) {
        ...
        if (str.trim().equals("FM1")) {
            ...
            this.radioData0 = 2;
        } else if (str.trim().equals("FM3")) {
            this.radioData0 = 3;
        } else if (str.trim().equals("AM1") || str.trim().equals("AM2")) {
            this.radioData0 = 4;
        }
        int i3 = this.radioData0;
        if (i3 == 1 || i3 == 2 || i3 == 3) {
        ...
        this.radioData3 = 0;
        getUiMgr(this.mContext).sendRadioInfo(this.radioData0, this.radioData1, this.radioData2, this.radioData3);
        getUiMgr(this.mContext).sendSourceInfo(1, 0, 0, 0, 0, 0, 0, 0);
    }
    ...
    public void btPhoneOutGoingInfoChange(byte[] bArr, boolean z, boolean z2) {
        ...
        this.huangUpTag = 0;
        getUiMgr(this.mContext).sendID3Info(bArr);
        ...
        getUiMgr(this.mContext).sendPhoneStateInfo();
    }
    ...
    public void btPhoneTalkingWithTimeInfoChange(byte[] bArr, boolean z, boolean z2, int i) {
        ...
        if (this.eachId == 4 && this.huangUpTag != 1) {
            getUiMgr(this.mContext);
            UiMgr.phoneStateData1Bit4 = 1;
            getUiMgr(this.mContext);
    ...
    public void btMusicInfoChange() {
        ...
        getUiMgr(this.mContext).sendSourceInfo(11, 0, 0, 0, 0, 0, 0, 0);
    }
    ...
    private void set0x3CInfo() {
        int drivingPageIndexes = getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_372_drive_data");
        ArrayList arrayList = new ArrayList();
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data1"), get0x3CState(DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[2]))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data2"), get0x3CState(DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[2]))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data4"), get0x3CState(DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[2]))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data5"), get0x3CState(DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[2]))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data6"), get0x3CState(DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[2]))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data7"), get0x3CState(DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[2]))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data8"), get0x3CState(DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[2]))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data9"), get0x3CState(DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[3]))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data10"), get0x3CState(DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[3]))));
        updateGeneralDriveData(arrayList);
        updateDriveDataActivity(null);
    }

    private String get0x3CState(boolean z) {
        if (!DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[2])) {
            return this.mContext.getString(R.string._372_drive_data02);
        }
        if (z) {
            return this.mContext.getString(R.string._372_drive_data01);
        }
        return this.mContext.getString(R.string._372_drive_data00);
    }
    ...
    private void setCarFactionState0x39() {
        int drivingPageIndexes = getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_333_driveData_factionState");
        ArrayList arrayList = new ArrayList();
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, 0, getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 0, 2))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, 1, getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 2, 2))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, 2, getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 4, 2))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, 3, getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 6, 2))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, 4, getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 0, 2))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, 5, getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 2, 2))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, 6, getCarStateMode(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 4, 3))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, 7, getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 0, 2))));
        arrayList.add(new DriverUpdateEntity(drivingPageIndexes, 8, getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 2, 2))));
        updateGeneralDriveData(arrayList);
        updateDriveDataActivity(null);
    }
    ...
    private void setEconomicModelInfo0x44() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_acc"), 3, getEconomicModelState(this.mCanBusInfoInt[2])).setValueStr(true));
    ...
    private void setAccInfo0xEA() {
        ...
        ArrayList arrayList = new ArrayList();
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_acc"), 0, getAccState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 0, 4))).setValueStr(true));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_acc"), 1, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 4, 4))));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_acc"), 2, Integer.valueOf(this.mCanBusInfoInt[3])));
        updateGeneralSettingData(arrayList);
        updateSettingActivity(null);
    ...
    private void setRadarSoundInfo0x3E() {
        int drivingPageIndexes = getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_333_drivePage_front_radar_info");
        ArrayList arrayList = new ArrayList();
        if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[2])) {
            arrayList.add(new DriverUpdateEntity(drivingPageIndexes, 3, this.mContext.getString(R.string._333_drivePage_front_radar_state_8)));
        } else {
            arrayList.add(new DriverUpdateEntity(drivingPageIndexes, 3, this.mContext.getString(R.string._333_drivePage_front_radar_state_9)));
        }
        updateGeneralDriveData(arrayList);
        updateDriveDataActivity(null);
    }
    ...
    private void setAirInfo0x21() {
        int[] iArr = this.mCanBusInfoInt;
        iArr[6] = blockBit(iArr[6], 1);
        int[] iArr2 = this.mCanBusInfoInt;
        iArr2[7] = 0;
        iArr2[6] = blockBit(iArr2[6], 2);
        if (isAirDataChange()) {
            return;
        }
        ...
        boolean z = (boolBit7 || boolBit6 || boolBit5) ? false : true;
        GeneralAirData.front_left_blow_window = boolBit7;
        GeneralAirData.front_right_blow_window = boolBit7;
        GeneralAirData.front_left_blow_head = boolBit6;
        GeneralAirData.front_right_blow_head = boolBit6;
        GeneralAirData.front_left_blow_foot = boolBit5;
        GeneralAirData.front_right_blow_foot = boolBit5;
        ...
        if (intFromByteWithBit == 0) {
            ...
            GeneralAirData.front_wind_level = intFromByteWithBit - 1;
        }
        String str = DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[6]) ? "F" : "C";
        GeneralAirData.front_left_temperature = getTemperature(this.mCanBusInfoInt[4], str, 0, 255);
        GeneralAirData.front_right_temperature = getTemperature(this.mCanBusInfoInt[5], str, 0, 255);
        ...
        GeneralAirData.auto_wind_lv = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[8], 6, 2);
    ...
    private void setCruiseSpeedLimit0x3D() {
        ...
        ArrayList arrayList = new ArrayList();
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_cruise_speed"), 0, Integer.valueOf(this.mCanBusInfoInt[2])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_cruise_speed"), 1, Integer.valueOf(this.mCanBusInfoInt[3])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_cruise_speed"), 2, Integer.valueOf(this.mCanBusInfoInt[4])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_cruise_speed"), 3, Integer.valueOf(this.mCanBusInfoInt[5])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_cruise_speed"), 4, Integer.valueOf(this.mCanBusInfoInt[6])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_cruise_speed"), 5, Integer.valueOf(this.mCanBusInfoInt[7])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_limit"), 0, Integer.valueOf(this.mCanBusInfoInt[8])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_limit"), 1, Integer.valueOf(this.mCanBusInfoInt[9])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_limit"), 2, Integer.valueOf(this.mCanBusInfoInt[10])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_limit"), 3, Integer.valueOf(this.mCanBusInfoInt[11])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_limit"), 4, Integer.valueOf(this.mCanBusInfoInt[12])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_limit"), 5, Integer.valueOf(this.mCanBusInfoInt[13])));
        updateGeneralSettingData(arrayList);
        updateSettingActivity(null);
    }
    ...
    private void setSpeed0x3B() {
        ...
        ArrayList arrayList = new ArrayList();
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 0, isShowSpeedTag(DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[2]))).setValueStr(true));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 1, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 7, 1))));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 2, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 6, 1))));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 3, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 5, 1))));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 4, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 4, 1))));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 5, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 3, 1))));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 6, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 2, 1))));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 7, Integer.valueOf(this.mCanBusInfoInt[3])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 8, Integer.valueOf(this.mCanBusInfoInt[4])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 9, Integer.valueOf(this.mCanBusInfoInt[5])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 10, Integer.valueOf(this.mCanBusInfoInt[6])));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 11, Integer.valueOf(this.mCanBusInfoInt[7])));
        updateGeneralSettingData(arrayList);
        updateSettingActivity(null);
    }

    private int getCarSettingRightIndex(String str) {
        return getUiMgr(this.mContext).getSettingRightIndex(this.mContext, "_333_setting_carState", str);
    }

    private void setCarState0x38() {
        int leftIndexes = getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_carState");
        ArrayList arrayList = new ArrayList();
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_1"), Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 7, 1))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_2"), getFuelState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 5, 1))).setValueStr(true));
        int intFromByteWithBit = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 5, 3);
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_7"), Integer.valueOf(intFromByteWithBit)).setProgress(intFromByteWithBit));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_8"), Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 4, 1))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_9"), Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 3, 1))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_10"), getReversingState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 2, 1))).setValueStr(true));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_11"), getPState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 1, 1))).setValueStr(true));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_12"), getLittleLampState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 0, 1))).setValueStr(true));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_13"), Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 6, 2))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_14"), Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 4, 2))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_15"), Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 3, 1))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_16"), Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 1, 2))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_18"), Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 7, 1))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_19"), Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 6, 1))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_20"), Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 5, 1))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_21"), Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 4, 1))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_22"), Integer.valueOf(getLangrage())));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_23"), Integer.valueOf(getFuelConsumptionUnit(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[7], 6, 2)))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, getCarSettingRightIndex("_333_setting_carState_25"), Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[7], 3, 1))));
        updateGeneralSettingData(arrayList);
        updateSettingActivity(null);
        int[] iArr = this.mCanBusInfoInt;
        iArr[3] = 0;
        ...
        if (isBasicInfoChange()) {
            ...
            GeneralDoorData.isSeatBeltTie = !DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[2]);
    ...
    private void setTripComputerInfo0x35() {
        getUiMgr(this.mContext).ComputerInfoData3Bit7 = 0;
        getUiMgr(this.mContext).ComputerInfoData3Bit5 = 0;
        ArrayList arrayList = new ArrayList();
        int leftIndexes = getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_2");
        ...
        int leftIndexes2 = getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_2");
        ...
        int leftIndexes3 = getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_2");
    ...
    private void setTripComputerInfo0x34() {
        getUiMgr(this.mContext).ComputerInfoData3Bit7 = 0;
        getUiMgr(this.mContext).ComputerInfoData3Bit6 = 0;
        ArrayList arrayList = new ArrayList();
        int leftIndexes = getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_1");
        StringBuilder sb = new StringBuilder();
        DecimalFormat decimalFormat = this.oneDecimal;
        int[] iArr = this.mCanBusInfoInt;
        arrayList.add(new SettingUpdateEntity(leftIndexes, 0, sb.append(decimalFormat.format(getMsbLsbResult(iArr[2], iArr[3]) * 0.1d)).append(" L/100Km").toString()).setValueStr(true));
        int leftIndexes2 = getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_1");
        StringBuilder sb2 = new StringBuilder();
        int[] iArr2 = this.mCanBusInfoInt;
        arrayList.add(new SettingUpdateEntity(leftIndexes2, 1, sb2.append(getMsbLsbResult(iArr2[4], iArr2[5])).append(" KM/H").toString()).setValueStr(true));
        int leftIndexes3 = getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_1");
        StringBuilder sb3 = new StringBuilder();
        int[] iArr3 = this.mCanBusInfoInt;
        arrayList.add(new SettingUpdateEntity(leftIndexes3, 2, sb3.append(getMsbLsbResult(iArr3[6], iArr3[7])).append(" KM").toString()).setValueStr(true));
        updateGeneralSettingData(arrayList);
    ...
    private void setTripComputerInfo0x33() {
        ArrayList arrayList = new ArrayList();
        int leftIndexes = getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_0");
        StringBuilder sb = new StringBuilder();
        DecimalFormat decimalFormat = this.oneDecimal;
        int[] iArr = this.mCanBusInfoInt;
        arrayList.add(new SettingUpdateEntity(leftIndexes, 0, sb.append(decimalFormat.format(getMsbLsbResult(iArr[2], iArr[3]) / 10)).append(" L/100KM").toString()).setValueStr(true));
        int leftIndexes2 = getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_0");
        StringBuilder sb2 = new StringBuilder();
        int[] iArr2 = this.mCanBusInfoInt;
        ...
        int leftIndexes3 = getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_0");
        StringBuilder sb3 = new StringBuilder();
        int[] iArr3 = this.mCanBusInfoInt;
        arrayList.add(new SettingUpdateEntity(leftIndexes3, 2, sb3.append(getMsbLsbResult(iArr3[6], iArr3[7])).append(" KM").toString()).setValueStr(true));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_0"), 3, this.timeFormat.format(this.mCanBusInfoInt[8]) + ":" + this.timeFormat.format(this.mCanBusInfoInt[9]) + ":" + this.timeFormat.format(this.mCanBusInfoInt[10])).setValueStr(true));
        updateGeneralSettingData(arrayList);
        updateSettingActivity(null);
    }
    ...
    private void haveDistanceInfo() {
        ...
        if (i == 1) {
            forceReverse(this.mContext, false);
            ArrayList arrayList = new ArrayList();
            arrayList.add(new DriverUpdateEntity(getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_333_drivePage_front_radar_info"), getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_333_drivePage_front_radar_left"), getRadarDistanceStr(this.mCanBusInfoInt[6])));
            arrayList.add(new DriverUpdateEntity(getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_333_drivePage_front_radar_info"), getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_333_drivePage_front_radar_mid"), getRadarDistanceStr(this.mCanBusInfoInt[7])));
            arrayList.add(new DriverUpdateEntity(getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_333_drivePage_front_radar_info"), getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_333_drivePage_front_radar_right"), getRadarDistanceStr(this.mCanBusInfoInt[8])));
            updateGeneralDriveData(arrayList);
            updateDriveDataActivity(null);
            return;
        }
    ...
    private void noHaveDistanceInfo() {
        ...
        getUiMgr(this.mContext).getParkPageUiSet(this.mContext).setShowRadar(false);
    }
                                ...
                                if (i2 != 1) {
                                    if (i2 != 2) {
                                        if (i2 == 3) {
                                            ...
                                            startSettingActivity(context, getUiMgr(context).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_2"), 0);
                                            this.computerInfoTag = 1;
                                            break;
                                        }
                                    } else {
                                        Context context2 = this.mContext;
                                        startSettingActivity(context2, getUiMgr(context2).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_1"), 0);
                                        this.computerInfoTag = 3;
                                        break;
                                    }
                                } else {
                                    Context context3 = this.mContext;
                                    startSettingActivity(context3, getUiMgr(context3).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_0"), 0);
    ...
    private void setVersionInfo0x71() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_page_1"), 0, getCarSeries(this.mCanBusInfoInt[2])).setValueStr(true));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_page_1"), 1, getCarModel(this.mCanBusInfoInt[3])).setValueStr(true));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_page_1"), 2, ((this.mCanBusInfoInt[4] + SystemConstant.THREAD_SLEEP_TIME_2000) - 6) + "年" + this.mCanBusInfoInt[5] + "月" + this.mCanBusInfoInt[6] + "日").setValueStr(true));
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_page_1"), 3, "V" + this.mCanBusInfoInt[8] + "." + this.mCanBusInfoInt[9] + "." + this.mCanBusInfoInt[10]).setValueStr(true));
        updateGeneralSettingData(arrayList);
        updateSettingActivity(null);
    }

    private void sendUSBInfo(String str, String str2) {
        if (str != null) {
            int[] byteArrayToIntArray = getByteArrayToIntArray(str.getBytes(StandardCharsets.UTF_8));
            int length = byteArrayToIntArray.length;
            MyLog.e("歌曲:" + str, "长度:" + length);
            if (length > 0) {
        ...
        getUiMgr(this.mContext).sendID3Info(4, this.data0xCB1, this.data0xCB2, this.data0xCB3, this.data0xCB4, this.data0xCB5, this.data0xCB6, this.data0xCB7, this.data0xCB8, this.data0xCB9, this.data0xCB10, this.data0xCB11, this.data0xCB12, this.data0xCB13, this.data0xCB14, this.data0xCB15, this.data0xCB16, this.data0xCB17, this.data0xCB18, this.data0xCB19, this.data0xCB20);
    }
    ...
    private String getTemperature(int i, String str, int i2, int i3) {
        if (i == i2) {
            return "LO";
        }
        if (i == i3) {
        ...
        if (str.trim().equals("C")) {
            return this.df_2Decimal.format(i * 0.5d) + getTempUnitC(this.mContext);
        }
    ...
    private String getSwitchState(int i) {
        ...
        return i == 2 ? this.mContext.getString(R.string._333_driveData_factionState_off) : "无";
    }
    ...
    private String getCarStateMode(int i) {
        ...
        return i == 4 ? this.mContext.getString(R.string._333_driveData_factionState7_4) : "无";
    }
    ...
    private void showDialog(final String str) {
        ...
        this.lastData = str;
        runOnUi(new AbstractMsgMgr.CallBackInterface() { // from class: com.hzbhd.canbus.car._372.MsgMgr.1
    ...
    /* JADX WARN: Type inference failed for: r6v0, types: [com.hzbhd.canbus.car._372.MsgMgr$2] */
    public void tireSetting() {
        new CountDownTimer(3000L, 500L) { // from class: com.hzbhd.canbus.car._372.MsgMgr.2
    ...
    public void updateSetUi(String str) {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new SettingUpdateEntity(getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_carState"), getUiMgr(this.mContext).getSettingRightIndex(this.mContext, "_333_setting_carState", "_333_setting_carState_25"), str).setValueStr(true));
        updateGeneralSettingData(arrayList);
        updateSettingActivity(null);
    }
