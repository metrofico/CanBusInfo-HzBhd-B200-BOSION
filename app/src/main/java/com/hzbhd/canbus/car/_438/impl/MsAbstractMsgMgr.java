package com.hzbhd.canbus.car._438.impl;
...
public class MsAbstractMsgMgr implements MsgMgrInterface {
    ...
    protected void realKeyLongClick1(Context context, int i, int i2) {
    ...
    private void registerMute() {
        this.isMute = ShareDataManager.getInstance().registerShareIntListener(ShareConstants.SHARE_AUDIO_MUTE, new IShareIntListener() { // from class: com.hzbhd.canbus.car._438.impl.MsAbstractMsgMgr.1
            @Override // com.hzbhd.proxy.share.interfaces.IShareIntListener
            public void onInt(int i) {
                MsAbstractMsgMgr.this.isMute = i == 1;
                MsAbstractMsgMgr msAbstractMsgMgr = MsAbstractMsgMgr.this;
                msAbstractMsgMgr.muteStateChange(msAbstractMsgMgr.isMute);
            }
        }) == 1;
    }
