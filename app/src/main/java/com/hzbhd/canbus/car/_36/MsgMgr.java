package com.hzbhd.canbus.car._36;
...
public class MsgMgr extends AbstractMsgMgr {
    static final String _36_IS_BACK_CAMERA = "_36_is_back_camera";
    static final String _36_IS_PANORAMIC = "_36_is_panoramic";
    private int FreqInt;
    ...
    private final String _36_ISLEFT_FRONT_DOOR_OPEN = "_36_isleft_front_door_open";
    private final String _36_ISRIGHT_FRONT_DOOR_OPEN = "_36_isright_front_door_open";
    private final String _36_ISRIGHT_REAR_DOOR_OPEN = "_36_isright_rear_door_open";
    private final String _36_ISLEFT_REAR_DOOR_OPEN = "_36_isleft_rear_door_open";
    private final String _36_ISBACK_OPEN = "_36_isback_open";
    private final String _36_AIR_REAR = "_36_air_rear";
    private final String _36_AIR_REAR_TEMP = "_36_air_rear_temp";
    ...
    private void initAmpCommand() {
        ...
        timerUtil.startTimer(new TimerTask() { // from class: com.hzbhd.canbus.car._36.MsgMgr.1
    ...
    private void setPanoramicStatus() {
        ...
        SharePreUtil.setBoolValue(this.mContext, _36_IS_BACK_CAMERA, intFromByteWithBit == 1);
        SharePreUtil.setBoolValue(this.mContext, _36_IS_PANORAMIC, intFromByteWithBit == 2);
        forceReverse(this.mContext, intFromByteWithBit != 0);
        if (SharePreUtil.getBoolValue(this.mContext, _36_IS_BACK_CAMERA, false) || CommUtil.isMiscReverse()) {
            int i = 1;
            while (i <= 4) {
                arrayList.add(new PanoramicBtnUpdateEntity(i - 1, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 0, 4) == i));
                i++;
            }
        } else if (SharePreUtil.getBoolValue(this.mContext, _36_IS_PANORAMIC, false)) {
            int i2 = 5;
            while (i2 <= 8) {
    ...
    private void setAirData0x21(byte[] bArr) {
        ...
        if (isOnlyRearUpdate()) {
            SharePreUtil.setIntValue(this.mContext, "_36_air_rear", this.isOnlyRearUpdate);
            SharePreUtil.setIntValue(this.mContext, "_36_air_rear_temp", this.isOnlyRearTempDate);
    ...
    */
    private void setTypeDataInfo() {
        ...
        L48:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hzbhd.canbus.car._36.MsgMgr.setTypeDataInfo():void");
    }
    ...
    private void setDoorData0x24() throws Resources.NotFoundException {
        ...
        if (isOnlyDoorMsgShow()) {
            SharePreUtil.setBoolValue(this.mContext, "_36_isleft_front_door_open", GeneralDoorData.isLeftFrontDoorOpen);
            SharePreUtil.setBoolValue(this.mContext, "_36_isright_front_door_open", GeneralDoorData.isRightFrontDoorOpen);
            SharePreUtil.setBoolValue(this.mContext, "_36_isright_rear_door_open", GeneralDoorData.isRightRearDoorOpen);
            SharePreUtil.setBoolValue(this.mContext, "_36_isleft_rear_door_open", GeneralDoorData.isLeftRearDoorOpen);
            SharePreUtil.setBoolValue(this.mContext, "_36_isback_open", GeneralDoorData.isBackOpen);
    ...
    void setLanguage_recNull(Context context) {
        int intValue = SharePreUtil.getIntValue(context, "_36_SAVE_LANGUAGE", 0);
        ArrayList arrayList = new ArrayList();
    ...
    private boolean isOnlyDoorMsgShow() {
        return (SharePreUtil.getBoolValue(this.mContext, "_36_isleft_front_door_open", false) == GeneralDoorData.isLeftFrontDoorOpen && SharePreUtil.getBoolValue(this.mContext, "_36_isright_front_door_open", false) == GeneralDoorData.isRightFrontDoorOpen && SharePreUtil.getBoolValue(this.mContext, "_36_isright_rear_door_open", false) == GeneralDoorData.isRightRearDoorOpen && SharePreUtil.getBoolValue(this.mContext, "_36_isleft_rear_door_open", false) == GeneralDoorData.isLeftRearDoorOpen && SharePreUtil.getBoolValue(this.mContext, "_36_isback_open", false) == GeneralDoorData.isBackOpen) ? false : true;
    }

    private boolean isOnlyRearUpdate() {
        return (SharePreUtil.getIntValue(this.mContext, "_36_air_rear", 0) == this.isOnlyRearUpdate && SharePreUtil.getIntValue(this.mContext, "_36_air_rear_temp", 0) == this.isOnlyRearTempDate) ? false : true;
    }
    ...
    void initAmplifierData(Context context) {
        if (context != null) {
            GeneralAmplifierData.frontRear = 10 - SharePreUtil.getIntValue(context, "_36_amplifier_fade", 0);
            GeneralAmplifierData.leftRight = SharePreUtil.getIntValue(context, "_36_amplifier_balance", 0) - 10;
            GeneralAmplifierData.bandBass = SharePreUtil.getIntValue(context, "_36_amplifier_bass", 0) - 10;
            GeneralAmplifierData.bandMiddle = SharePreUtil.getIntValue(context, "_36_amplifier_middle", 0) - 10;
            GeneralAmplifierData.bandTreble = SharePreUtil.getIntValue(context, "_36_amplifier_treble", 0) - 10;
        }
