...
public class MsgMgr extends AbstractMsgMgr {
    ...
    private void initAmplifier(Context context) {
        ...
        timerUtil.startTimer(new TimerTask() { // from class: com.hzbhd.canbus.car._293.MsgMgr.1
    ...
    private void startTask() {
        ...
        if (timer == null) {
            ...
            this.mTimer = timer2;
            timer2.schedule(new TimerTask() { // from class: com.hzbhd.canbus.car._293.MsgMgr.2
                int i = 0;
