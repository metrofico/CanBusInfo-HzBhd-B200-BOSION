...
public class MyPanoramicView extends RelativeLayout implements View.OnClickListener, View.OnTouchListener {
    ...
    private void sendUpDownCommand(byte[] bArr, final byte[] bArr2, long j) {
        ...
        startTimer(new TimerTask() { // from class: com.hzbhd.canbus.car._21.MyPanoramicView.1
            @Override // java.util.TimerTask, java.lang.Runnable
            public void run() {
                CanbusMsgSender.sendMsg(bArr2);
                MyPanoramicView.this.stopTimer();
            }
        }, j);
    }
