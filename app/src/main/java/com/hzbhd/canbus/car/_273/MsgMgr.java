...
public class MsgMgr extends AbstractMsgMgr {
    ...
    public static final String SAVE_AIRINFO_1 = "_273_airInfo1";
    public static final String SAVE_AIRINFO_2 = "_273_airInfo2";
    public static final String SAVE_COMMON_SWITCH = "_273_commonSwitch";
    public static final String SAVE_SPLIT = ",";
    private static final String TAG = "_273_MsgMgr";
