...
public class UiMgr extends AbstractUiMgr {
    ...
    private OnAirBtnClickListener mOnFrontAirTopBtnClickListener = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.3
    ...
    private OnAirBtnClickListener mOnFrontAirBottomLeftBtnClickListener = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.4
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            if (i == 0) {
    ...
    private OnAirBtnClickListener mOnFrontAirBottomRightBtnClickListener = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.5
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
    ...
    int windSpeed = 0;
    private OnAirBtnClickListener mOnFrontOnAirBottomBtnClickListener = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.6
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            if (i == 0) {
                if (UiMgr.this.windSpeed == 0) {
                    CanbusMsgSender.sendMsg(new byte[]{22, 58, 1, 0});
                    UiMgr.this.windSpeed = 1;
                    return;
                } else if (UiMgr.this.windSpeed == 1) {
                    CanbusMsgSender.sendMsg(new byte[]{22, 58, 1, 1});
                    UiMgr.this.windSpeed = 2;
                    return;
                } else {
                    CanbusMsgSender.sendMsg(new byte[]{22, 58, 1, 2});
                    UiMgr.this.windSpeed = 0;
                    return;
                }
            }
            if (i == 1) {
    ...
    private OnAirSeatClickListener mOnFrontAirSeatClickListener = new OnAirSeatClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.7
    ...
    private OnAirTemperatureUpDownClickListener mFrontTempSetViewOnUpDownClickListenerLeft = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.8
    ...
    private OnAirTemperatureUpDownClickListener mFrontTempSetViewOnUpDownClickListenerRight = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.9
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirTemperatureUpDownClickListener
        public void onClickUp() {
            int i = 255;
            if (GeneralAirData.fahrenheit_celsius) {
    ...
    private OnAirWindSpeedUpDownClickListener mSetFrontWindSpeedViewOnClickListener = new OnAirWindSpeedUpDownClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.10
    ...
    private OnAirSeatHeatColdMinPlusClickListener mFrontLeftSeatHeatListener = new OnAirSeatHeatColdMinPlusClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.11
        ...
        public void onClickPlus() {
            if (GeneralAirData.front_left_seat_heat_level == 3) {
                UiMgr.this.sendSeatHeatColdMsg(0, 33);
            } else {
                UiMgr.this.sendSeatHeatColdMsg(GeneralAirData.front_left_seat_heat_level + 1, 33);
            }
        }
    };
    private OnAirSeatHeatColdMinPlusClickListener mFrontRightSeatHeatListener = new OnAirSeatHeatColdMinPlusClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.12
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirSeatHeatColdMinPlusClickListener
        public void onClickMin() {
        ...
        public void onClickPlus() {
            if (GeneralAirData.front_right_seat_heat_level == 3) {
                UiMgr.this.sendSeatHeatColdMsg(0, 34);
            } else {
                UiMgr.this.sendSeatHeatColdMsg(GeneralAirData.front_right_seat_heat_level + 1, 34);
            }
        }
    };
    private OnAirSeatHeatColdMinPlusClickListener mFrontLeftSeatColdListener = new OnAirSeatHeatColdMinPlusClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.13
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirSeatHeatColdMinPlusClickListener
        public void onClickMin() {
            if (GeneralAirData.front_left_seat_cold_level == 0) {
                UiMgr.this.sendSeatHeatColdMsg(3, 37);
            } else {
        ...
        public void onClickPlus() {
            if (GeneralAirData.front_left_seat_cold_level == 3) {
                UiMgr.this.sendSeatHeatColdMsg(0, 37);
            } else {
                UiMgr.this.sendSeatHeatColdMsg(GeneralAirData.front_left_seat_cold_level + 1, 37);
            }
        }
    };
    private OnAirSeatHeatColdMinPlusClickListener mFrontRightSeatColdListener = new OnAirSeatHeatColdMinPlusClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.14
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirSeatHeatColdMinPlusClickListener
        public void onClickMin() {
            if (GeneralAirData.front_right_seat_cold_level == 0) {
                UiMgr.this.sendSeatHeatColdMsg(3, 38);
            } else {
        ...
        public void onClickPlus() {
            if (GeneralAirData.front_right_seat_cold_level == 3) {
                UiMgr.this.sendSeatHeatColdMsg(0, 38);
            } else {
                UiMgr.this.sendSeatHeatColdMsg(GeneralAirData.front_right_seat_cold_level + 1, 38);
            }
        }
    };
    private OnAirSeatHeatColdMinPlusClickListener mRearLeftSeatHeatColdListener = new OnAirSeatHeatColdMinPlusClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.15
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirSeatHeatColdMinPlusClickListener
        public void onClickMin() {
    ...
    private OnAirSeatHeatColdMinPlusClickListener mRearRightSeatHeatColdListener = new OnAirSeatHeatColdMinPlusClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.16
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirSeatHeatColdMinPlusClickListener
        public void onClickMin() {
    ...
    private OnAirTemperatureUpDownClickListener mRearTempSetViewOnUpDownClickListenerCenter = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.17
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirTemperatureUpDownClickListener
        public void onClickUp() {
            int i = 255;
            if (GeneralAirData.fahrenheit_celsius) {
    ...
    private OnAirWindSpeedUpDownClickListener mSetRearWindSpeedViewOnClickListener = new OnAirWindSpeedUpDownClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.18
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirWindSpeedUpDownClickListener
        public void onClickLeft() {
    ...
    private OnAirBtnClickListener mOnRearAirButtomBtnClickListener = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.19
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            if (i == 0) {
    ...
    private OnAirSeatClickListener mOnRearAirSeatClickListener = new OnAirSeatClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.20
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirSeatClickListener
        public void onLeftSeatClick() {
    ...
    private OnSettingItemSelectListener mOnItemSelectedListener = new OnSettingItemSelectListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.21
    ...
    private OnSettingItemSeekbarSelectListener mOnSeekBarChangeListener = new OnSettingItemSeekbarSelectListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.22
    ...
    private OnPanoramicItemClickListener mOnPanoramicItemClickListener = new OnPanoramicItemClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.23
        @Override // com.hzbhd.canbus.interfaces.OnPanoramicItemClickListener
        public void onClickItem(int i) {
            if (i == 0) {
                if (MsgMgr.isPanoramicRadarClose) {
                    CanbusMsgSender.sendMsg(new byte[]{22, -14, 15, 0});
                    return;
                } else {
                    CanbusMsgSender.sendMsg(new byte[]{22, -14, 15, 1});
                    return;
                }
            }
            if (i == 1) {
    ...
    public UiMgr(Context context) {
        ...
        settingUiSet.setOnSettingConfirmDialogListener(new OnConfirmDialogListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.1
        ...
        settingUiSet.setOnSettingItemClickListener(new OnSettingItemClickListener() { // from class: com.hzbhd.canbus.car._206.UiMgr.2
            @Override // com.hzbhd.canbus.interfaces.OnSettingItemClickListener
            public void onClickItem(int i, int i2) {
                UiMgr uiMgr = UiMgr.this;
                if (i == uiMgr.getSettingLeftIndexes(uiMgr.mContext, "_206_new_function3")) {
                    UiMgr uiMgr2 = UiMgr.this;
                    if (i2 == uiMgr2.getSettingRightIndex(uiMgr2.mContext, "_206_new_function3", "_206_new_function4")) {
                        UiMgr.this.mMsgMgr.syncTime();
                    }
                }
            }
        });
