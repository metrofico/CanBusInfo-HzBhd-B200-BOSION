...
public class MsgMgr extends AbstractMsgMgr {
    ...
    public void initCommand(Context context) {
        ...
        ((UiMgr) UiMgrFactory.getCanUiMgr(context)).initAmplifierInfo();
        getUigMgr(this.mContext).selectionCarModel();
    }
    ...
    public void btPhoneHangUpInfoChange(byte[] bArr, boolean z, boolean z2) {
        ...
        runOnUi(new AbstractMsgMgr.CallBackInterface() { // from class: com.hzbhd.canbus.car._345.MsgMgr.1
            @Override // com.hzbhd.canbus.msg_mgr.AbstractMsgMgr.CallBackInterface
            public void callback() {
                new CountDownTimer(2000L, 500L) { // from class: com.hzbhd.canbus.car._345.MsgMgr.1.1
    ...
    private void set0x80VideoInfo() {
        ...
        arrayList.add(new SettingUpdateEntity(getUigMgr(this.mContext).getSettingLeftIndexes(this.mContext, "_345_bmw_car"), getUigMgr(this.mContext).getSettingRightIndex(this.mContext, "_345_bmw_car", "_345_bmw_car_0"), Integer.valueOf(this.mCanBusInfoInt[4])));
        arrayList.add(new SettingUpdateEntity(getUigMgr(this.mContext).getSettingLeftIndexes(this.mContext, "_345_bmw_car"), getUigMgr(this.mContext).getSettingRightIndex(this.mContext, "_345_bmw_car", "_345_bmw_car_1"), Integer.valueOf(this.mCanBusInfoInt[5] - 1)));
        arrayList.add(new SettingUpdateEntity(getUigMgr(this.mContext).getSettingLeftIndexes(this.mContext, "_345_bmw_car"), getUigMgr(this.mContext).getSettingRightIndex(this.mContext, "_345_bmw_car", "_345_bmw_car_2"), Integer.valueOf(this.mCanBusInfoInt[6] - 6)));
    ...
    private void set0x29WheelKeyInfo() {
        ...
        if (i == 1 || i == 8 || i == 9 || i == 10) {
            ...
            int i2 = this.nowValue;
            if (i2 == 1000) {
                this.nowValue = iArr[3];
                return;
            }
            int i3 = iArr[3];
            if (i3 < i2) {
    ...
    private void set0x25ParkingInfo() {
        ...
        if (i == 8 || i == 9 || i == 10) {
            ArrayList arrayList = new ArrayList();
            arrayList.add(new SettingUpdateEntity(getUigMgr(this.mContext).getSettingLeftIndexes(this.mContext, "_246_paring_info"), 2, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 2, 2))));
    ...
    private void showDialog(final String str) {
        runOnUi(new AbstractMsgMgr.CallBackInterface() { // from class: com.hzbhd.canbus.car._345.MsgMgr.2
            @Override // com.hzbhd.canbus.msg_mgr.AbstractMsgMgr.CallBackInterface
            public void callback() {
