...
import com.hzbhd.canbus.car_cus._439.air.window.AirWindow;
import com.hzbhd.canbus.car_cus._439.drive.data.DriveData;
...
import com.hzbhd.canbus.car_cus._439.smartPanel.window.PanelButton;
...
public class MsgMgr extends AbstractMsgMgr {
    ...
    int nowError = 0;
    private Handler mHandler = new Handler(Looper.getMainLooper()) { // from class: com.hzbhd.canbus.car._439.MsgMgr.4
        @Override // android.os.Handler
        public void handleMessage(Message message) {
            super.handleMessage(message);
            switch (message.what) {
                case 252:
                    if (Settings.System.getInt(BaseUtil.INSTANCE.getContext().getContentResolver(), "CAN_BUS_SMART_PANEL_PAGE_SWITCH_439", 1) == 1 && !MsgMgr.this.panelButton.getShowTag()) {
    ...
    public void onHandshake(Context context) {
        ...
        CanbusMsgSender.sendMsg(new byte[]{22, -112, 34, 0});
        CanbusMsgSender.sendMsg(new byte[]{22, -112, 54, 0});
    }
    ...
    public void initCommand(final Context context) {
        ...
        runOnUi(new AbstractMsgMgr.CallBackInterface() { // from class: com.hzbhd.canbus.car._439.MsgMgr.1
            ...
            public void callback() {
                if (Settings.System.getInt(BaseUtil.INSTANCE.getContext().getContentResolver(), "CAN_BUS_SMART_PANEL_PAGE_SWITCH_439", 1) == 1) {
                    if (MsgMgr.this.panelButton == null) {
                        MsgMgr.this.panelButton = new PanelButton(context, new PanelButton.PanoramaListener() { // from class: com.hzbhd.canbus.car._439.MsgMgr.1.1
                            @Override // com.hzbhd.canbus.car_cus._439.smartPanel.window.PanelButton.PanoramaListener
                            public void clickEvent() {
                                MsgMgr.this.startOtherActivity(context, HzbhdComponentName.ID439PanelActivity);
                            }
                        });
                    }
                    MsgMgr.this.panelButton.show();
    ...
    private void checkCarConfig(int[] iArr) {
        ...
        BaseUtil.INSTANCE.runUi(new Function0<Unit>() { // from class: com.hzbhd.canbus.car._439.MsgMgr.2
    ...
    private void setAirAlert(int i) {
        ...
        runOnUi(new AbstractMsgMgr.CallBackInterface() { // from class: com.hzbhd.canbus.car._439.MsgMgr.3
            @Override // com.hzbhd.canbus.msg_mgr.AbstractMsgMgr.CallBackInterface
            public void callback() {
                try {
    ...
    public void registerAirControlListener() {
        ShareDataManager.getInstance().registerShareStringListener(ShareConstants.SHARE_REQUEST_ALL_DATA, new IShareStringListener() { // from class: com.hzbhd.canbus.car._439.MsgMgr$$ExternalSyntheticLambda0
            @Override // com.hzbhd.proxy.share.interfaces.IShareStringListener
            public final void onString(String str) {
                this.f$0.m863x20d67ff1(str);
            }
        });
    }

    /* renamed from: lambda$registerAirControlListener$0$com-hzbhd-canbus-car-_439-MsgMgr, reason: not valid java name */
    /* synthetic */ void m863x20d67ff1(String str) {
