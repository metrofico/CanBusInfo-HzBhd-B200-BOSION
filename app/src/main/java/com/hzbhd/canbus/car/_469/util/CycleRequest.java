package com.hzbhd.canbus.car._469.util;
...
public class CycleRequest {
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper()) { // from class: com.hzbhd.canbus.car._469.util.CycleRequest.1
