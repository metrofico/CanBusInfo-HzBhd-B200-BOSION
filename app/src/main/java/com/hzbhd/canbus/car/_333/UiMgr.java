...
public class UiMgr extends AbstractUiMgr {
    ...
    Context mContext;
    MsgMgr mMsgMgr;
    OnSettingItemSelectListener onSettingItemSelectListener = new OnSettingItemSelectListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.1
    ...
    OnSettingItemSeekbarSelectListener onSettingItemSeekbarSelectListener = new OnSettingItemSeekbarSelectListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.2
    ...
    OnConfirmDialogListener onConfirmDialogListener = new OnConfirmDialogListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.3
    ...
    OnSettingPageStatusListener onSettingPageStatusListener = new OnSettingPageStatusListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.4
    ...
    OnAirBtnClickListener mOnAirBtnClickListenerFrontBottom = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.5
    ...
    OnAirTemperatureUpDownClickListener mOnUpDownClickListenerRearLeft = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.6
    ...
    OnAirTemperatureUpDownClickListener mOnUpDownClickListenerRearRight = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.7
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirTemperatureUpDownClickListener
        public void onClickUp() {
    ...
    OnAirSeatClickListener onAirSeatClickListener = new OnAirSeatClickListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.8
    ...
    OnAirWindSpeedUpDownClickListener onAirWindSpeedUpDownClickListener = new OnAirWindSpeedUpDownClickListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.9
    ...
    OnAmplifierPositionListener onAmplifierPositionListener = new OnAmplifierPositionListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.10
        ...
        public void position(AmplifierActivity.AmplifierPosition amplifierPosition, int i) {
            ...
            if (i2 == 1) {
                UiMgr.this.sendAmplifierInfo(3, (-i) + 10);
            } else {
                if (i2 != 2) {
                    return;
                }
                UiMgr.this.sendAmplifierInfo(4, i + 10);
            }
        }
    };
    OnAmplifierSeekBarListener onAmplifierSeekBarListener = new OnAmplifierSeekBarListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.11
        ...
        public void progress(AmplifierActivity.AmplifierBand amplifierBand, int i) {
            ...
            if (i2 == 1) {
                UiMgr.this.sendAmplifierInfo(6, i + 3);
            } else {
                if (i2 != 2) {
                    return;
                }
                UiMgr.this.sendAmplifierInfo(5, i + 3);
            }
        }
    };
    OnAmplifierCreateAndDestroyListener onAmplifierCreateAndDestroyListener = new OnAmplifierCreateAndDestroyListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.12
    ...
    OnPanelKeyPositionListener onPanelKeyPositionListener = new OnPanelKeyPositionListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.13
    ...
    OnWarningStatusChangeListener onWarningStatusChangeListener = new OnWarningStatusChangeListener() { // from class: com.hzbhd.canbus.car._333.UiMgr.14
    ...
    /* renamed from: com.hzbhd.canbus.car._333.UiMgr$15, reason: invalid class name */
