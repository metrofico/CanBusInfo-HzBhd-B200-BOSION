...
public class MsAbstractMsgMgr implements MsgMgrInterface {
    ...
    private void registerMute() {
        this.isMute = ShareDataManager.getInstance().registerShareIntListener(ShareConstants.SHARE_AUDIO_MUTE, new IShareIntListener() { // from class: com.hzbhd.canbus.car._434.impl.MsAbstractMsgMgr.1
