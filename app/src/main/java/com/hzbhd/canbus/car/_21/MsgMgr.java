...
public class MsgMgr extends AbstractMsgMgr {
    ...
    private void setAirData0x21() {
        ...
        GeneralAirData.front_window_heat = DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[6]);
    ...
    private void setPanoramicUiData0x94() {
        ...
        if (this.mCanBusInfoInt[4] >= this.mTipsArray.size()) {
            return;
        }
        ...
        runOnUi(new AbstractMsgMgr.CallBackInterface() { // from class: com.hzbhd.canbus.car._21.MsgMgr.1
    ...
    public void showButton() {
        runOnUi(new AbstractMsgMgr.CallBackInterface() { // from class: com.hzbhd.canbus.car._21.MsgMgr.2
            @Override // com.hzbhd.canbus.msg_mgr.AbstractMsgMgr.CallBackInterface
            public void callback() {
                if (MsgMgr.this.systemButton == null) {
                    MsgMgr.this.systemButton = new SystemButton(MsgMgr.this.getActivity(), "P", new SystemButton.PanoramaListener() { // from class: com.hzbhd.canbus.car._21.MsgMgr.2.1
    ...
    public void hideButton() {
        if (this.systemButton == null) {
            this.systemButton = new SystemButton(getActivity(), "P", new SystemButton.PanoramaListener() { // from class: com.hzbhd.canbus.car._21.MsgMgr.3
                @Override // com.hzbhd.canbus.util.SystemButton.PanoramaListener
                public void clickEvent() {
                    CanbusMsgSender.sendMsg(new byte[]{22, -58, 2, 3});
                    CanbusMsgSender.sendMsg(new byte[]{22, -58, 2, 4});
