...
public class MsgMgr extends MsAbstractMsgMgr {
    ...
    @Override // com.hzbhd.canbus.car._438.impl.MsAbstractMsgMgr, com.hzbhd.canbus.interfaces.MsgMgrInterface
    ...
    private void sendAirInfoToSpeech(byte[] bArr) {
        ...
        int intFromByteWithBit = DataHandleUtils.getIntFromByteWithBit(bArr[8], 3, 3);
        ...
        if (DataHandleUtils.getIntFromByteWithBit(bArr[8], 3, 3) == 5) {
            sa.sendDefrost(true);
        } else {
            sa.sendDefrost(false);
        }
        sa.sendWind(DataHandleUtils.getIntFromByteWithBit(bArr[9], 4, 4));
        if (DataHandleUtils.getIntFromByteWithBit(bArr[7], 1, 2) == 0) {
            sa.sendCold(false);
        } else if (DataHandleUtils.getIntFromByteWithBit(bArr[7], 1, 2) == 1) {
            sa.sendCold(true);
        }
        if (DataHandleUtils.getIntFromByteWithBit(bArr[7], 4, 1) == 0) {
            sa.sendAir(false);
        } else {
            sa.sendAir(true);
        }
        if (DataHandleUtils.getIntFromByteWithBit(bArr[8], 7, 1) == 0) {
            sa.sendLoop(true);
        } else {
            sa.sendLoop(false);
        }
    ...
    private class SanYiVoiceControl implements ISysRxListener {
        @Override // com.hzbhd.canbus.car._438.speech.ISysRxListener
