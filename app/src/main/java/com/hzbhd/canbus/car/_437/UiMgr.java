...
public class UiMgr extends AbstractUiMgr {
    ...
    public UiMgr(Context context) {
        ...
        getDriverDataPageUiSet(this.mContext).setOnDriveDataPageStatusListener(new OnDriveDataPageStatusListener() { // from class: com.hzbhd.canbus.car._437.UiMgr.1
            @Override // com.hzbhd.canbus.interfaces.OnDriveDataPageStatusListener
            public void onStatusChange(int i) {
                UiMgr.this.activeRequest(3, 0);
            }
        });
        getAirUiSet(this.mContext).getFrontArea().setOnAirPageStatusListener(new OnAirPageStatusListener() { // from class: com.hzbhd.canbus.car._437.UiMgr.2
    ...
    public void issueAux(boolean z) {
        if (z) {
