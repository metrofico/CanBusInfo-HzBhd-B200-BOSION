...
public class UiMgr extends AbstractUiMgr {
    ...
    private OnOriginalTopBtnClickListener mOnOriginalTopBtnClickListener = new OnOriginalTopBtnClickListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.4
    ...
    private OnOriginalBottomBtnClickListener mOnOriginalBottomBtnClickListener = new OnOriginalBottomBtnClickListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.5
    ...
    private OnOriginalCarDevicePageStatusListener mOnOriginalCarDevicePageStatusListener = new OnOriginalCarDevicePageStatusListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.6
        /* JADX WARN: Type inference failed for: r2v3, types: [com.hzbhd.canbus.car._213.UiMgr$6$1] */
        ...
        public void onStatusChange(int i) {
            ...
            new Thread() { // from class: com.hzbhd.canbus.car._213.UiMgr.6.1
    ...
    private OnOriginalCarDeviceBackPressedListener mOnOriginalCarDeviceBackPressedListener = new OnOriginalCarDeviceBackPressedListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.7
        @Override // com.hzbhd.canbus.interfaces.OnOriginalCarDeviceBackPressedListener
        public void onBackPressed() {
            CanbusMsgSender.sendMsg(new byte[]{22, -14, 1});
        }
    };
    private OnSettingItemSelectListener mOnSettingItemSelectListener = new OnSettingItemSelectListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.8
        ...
        public void onClickItem(int i, int i2, int i3) {
            ...
            switch (i2) {
                ...
                case 42:
                    ...
                    UiMgr.this.getMsgMgr().updateSettings(i, i2, i3);
                    SharePreUtil.setIntValue(UiMgr.this.mContext, UiMgr.SHARE_213_LANGUAGE, i3);
                    break;
            }
        }
    };
    private OnSettingPageStatusListener mOnSettingPageStatusListener = new OnSettingPageStatusListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.9
    ...
    private OnSettingItemSeekbarSelectListener mOnSettingItemSeekbarSelectListener = new OnSettingItemSeekbarSelectListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.10
    ...
    private OnAirPageStatusListener mOnAirPageStatusListener = new OnAirPageStatusListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.11
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirPageStatusListener
        public void onStatusChange(int i) {
            CanbusMsgSender.sendMsg(new byte[]{22, 106, 5, 1, 49});
        }
    };
    private OnAmplifierSeekBarListener mAmplifierSeekBarListener = new OnAmplifierSeekBarListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.12
    ...
    private OnAmplifierPositionListener mOnAmplifierPositionListener = new OnAmplifierPositionListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.13
    ...
    public UiMgr(final Context context) {
        ...
        getMsgMgr().updateSettings(0, 42, SharePreUtil.getIntValue(context, SHARE_213_LANGUAGE, 0));
        ...
        getDriverDataPageUiSet(context).setOnDriveDataPageStatusListener(new OnDriveDataPageStatusListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.1
        ...
        settingUiSet.setOnSettingConfirmDialogListener(new OnConfirmDialogListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.2
        ...
        settingUiSet.setOnSettingItemClickListener(new OnSettingItemClickListener() { // from class: com.hzbhd.canbus.car._213.UiMgr.3
            @Override // com.hzbhd.canbus.interfaces.OnSettingItemClickListener
            public void onClickItem(int i, int i2) {
                UiMgr uiMgr = UiMgr.this;
                if (i == uiMgr.getSettingLeftIndexes(uiMgr.mContext, "_touchpad_0")) {
                    UiMgr uiMgr2 = UiMgr.this;
                    if (i2 == uiMgr2.getSettingRightIndex(uiMgr2.mContext, "_touchpad_0", "_touchpad_0")) {
                        UiMgr.this.getMsgMgr().touchpadView();
                    }
                }
            }
        });
    ...
    /* renamed from: com.hzbhd.canbus.car._213.UiMgr$14, reason: invalid class name */
