...
public class UiMgr extends AbstractUiMgr {
    ...
    OnSettingItemSelectListener onSettingItemSelectListener = new OnSettingItemSelectListener() { // from class: com.hzbhd.canbus.car._451.UiMgr.2
            ...
            if (i == uiMgr3.getSettingLeftIndexes(uiMgr3.mContext, "_451_resolving_power")) {
                ...
                if (i2 == uiMgr4.getSettingRightIndex(uiMgr4.mContext, "_451_resolving_power", "_451_reverse_flag")) {
                    if (i3 == 0) {
                        ...
                        uiMgr5.getMsgMgr(uiMgr5.mContext).updateSettingsUi(UiMgr.this.mContext, i, i2, UiMgr.this.CAMERA_FLAG_TAG_451, 0);
                    } else if (i3 == 1) {
                        CanbusConfig.INSTANCE.setCameraConfiguration(false);
                        UiMgr uiMgr6 = UiMgr.this;
                        uiMgr6.getMsgMgr(uiMgr6.mContext).updateSettingsUi(UiMgr.this.mContext, i, i2, UiMgr.this.CAMERA_FLAG_TAG_451, 1);
                    }
                }
    ...
    OnSettingItemSeekbarSelectListener mOnSettingItemSeekbarSelectListener = new OnSettingItemSeekbarSelectListener() { // from class: com.hzbhd.canbus.car._451.UiMgr.3
    ...
    OnSettingItemClickListener onSettingItemClickListener = new OnSettingItemClickListener() { // from class: com.hzbhd.canbus.car._451.UiMgr.4
        ...
        public void onClickItem(int i, int i2) {
            ...
            if (i == uiMgr.getSettingLeftIndexes(uiMgr.mContext, "_451_activation")) {
                ...
                if (i2 == uiMgr2.getSettingRightIndex(uiMgr2.mContext, "_451_activation", "_451_activation_1")) {
                    ...
                    BaseUtil.INSTANCE.runUi(new Function0<Unit>() { // from class: com.hzbhd.canbus.car._451.UiMgr.4.1
    ...
    public UiMgr(Context context) {
        ...
        if (this.eachId == 1) {
            removeFrontAirButtonByName(context, "in_out_cycle");
            removeFrontAirButtonByName(context, "ac");
        ...
        getDriverDataPageUiSet(context).setOnDriveDataPageStatusListener(new OnDriveDataPageStatusListener() { // from class: com.hzbhd.canbus.car._451.UiMgr.1
            @Override // com.hzbhd.canbus.interfaces.OnDriveDataPageStatusListener
            public void onStatusChange(int i) {
                if (i == -1) {
                    CycleRequestSpeed.getInstance().start(0, new ActionCallback() { // from class: com.hzbhd.canbus.car._451.UiMgr.1.1
        ...
        initCamera(context);
        removeSettingRightItemByNameList(context, new String[]{"_451_benz_fbv", "_451_bmw_fbv"});
        initCamera(context);
        initResolutionAatio();
    }
    ...
    private void initCamera(Context context) {
        int intValue = SharePreUtil.getIntValue(context, this.CAMERA_FLAG_TAG_451, -1);
        if (intValue == -1) {
            getMsgMgr(context).updateSettingsUi(context, getSettingLeftIndexes(context, "_451_resolving_power"), getSettingRightIndex(context, "_451_resolving_power", "_451_reverse_flag"), this.CAMERA_FLAG_TAG_451, 1 ^ (CanbusConfig.INSTANCE.getCameraConfiguration() ? 1 : 0));
        } else {
            getMsgMgr(context).updateSettingsUi(context, getSettingLeftIndexes(context, "_451_resolving_power"), getSettingRightIndex(context, "_451_resolving_power", "_451_reverse_flag"), this.CAMERA_FLAG_TAG_451, intValue);
