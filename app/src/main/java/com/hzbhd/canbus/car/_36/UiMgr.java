...
public class UiMgr extends AbstractUiMgr {
    ...
    static final String _36_AMPLIFIER_FADE = "_36_amplifier_fade";
    static final String _36_AMPLIFIER_MIDDLE = "_36_amplifier_middle";
    static final String _36_AMPLIFIER_TREBLE = "_36_amplifier_treble";
    static final String _36_SAVE_LANGUAGE = "_36_SAVE_LANGUAGE";
    private int data1;
    private int data2;
    private int data3;
    private int data4;
    ...
    public UiMgr(final Context context) {
        ...
        settingUiSet.setOnSettingItemSelectListener(new OnSettingItemSelectListener() { // from class: com.hzbhd.canbus.car._36.UiMgr.1
            ...
            public void onClickItem(int i, int i2, int i3) {
                ...
                SharePreUtil.setIntValue(context, UiMgr._36_SAVE_LANGUAGE, i3);
                UiMgr.this.msgMgr.setLanguage_recNull(context);
            }
        });
        AmplifierPageUiSet amplifierPageUiSet = getAmplifierPageUiSet(context);
        amplifierPageUiSet.setOnAmplifierPositionListener(new OnAmplifierPositionListener() { // from class: com.hzbhd.canbus.car._36.UiMgr.2
            ...
            public void position(AmplifierActivity.AmplifierPosition amplifierPosition, int i) {
                ...
                if (i2 == 1) {
                    ...
                    SharePreUtil.setIntValue(context, UiMgr._36_AMPLIFIER_FADE, UiMgr.this.data1);
                    UiMgr.this.msgMgr.initAmplifierData(context);
                } else if (i2 == 2) {
                    UiMgr.this.data2 = i + 10;
                    SharePreUtil.setIntValue(context, UiMgr._36_AMPLIFIER_BALANCE, UiMgr.this.data2);
                    UiMgr.this.msgMgr.initAmplifierData(context);
                }
        ...
        amplifierPageUiSet.setOnAmplifierSeekBarListener(new OnAmplifierSeekBarListener() { // from class: com.hzbhd.canbus.car._36.UiMgr.3
            ...
            public void progress(AmplifierActivity.AmplifierBand amplifierBand, int i) {
                ...
                if (i2 == 1) {
                    ...
                    UiMgr.this.data3 = i3;
                    SharePreUtil.setIntValue(context, UiMgr._36_AMPLIFIER_TREBLE, UiMgr.this.data3);
                    UiMgr.this.msgMgr.initAmplifierData(context);
                    return;
                }
                if (i2 == 2) {
                    ...
                    UiMgr.this.data4 = i4;
                    SharePreUtil.setIntValue(context, UiMgr._36_AMPLIFIER_MIDDLE, UiMgr.this.data4);
                    UiMgr.this.msgMgr.initAmplifierData(context);
                    return;
                }
                if (i2 != 3) {
                ...
                UiMgr.this.data5 = i5;
                SharePreUtil.setIntValue(context, UiMgr._36_AMPLIFIER_BASS, UiMgr.this.data5);
                UiMgr.this.msgMgr.initAmplifierData(context);
            }
        });
        parkPageUiSet.setOnPanoramicItemClickListener(new OnPanoramicItemClickListener() { // from class: com.hzbhd.canbus.car._36.UiMgr.4
            @Override // com.hzbhd.canbus.interfaces.OnPanoramicItemClickListener
            public void onClickItem(int i) {
                int i2 = (SharePreUtil.getBoolValue(context, "_36_is_back_camera", false) || CommUtil.isMiscReverse()) ? 1 : 5;
                Log.d("cwh", "rev = " + i2);
                CanbusMsgSender.sendMsg(new byte[]{22, -124, 1, (byte) (i + i2)});
            }
        });
        parkPageUiSet.setOnBackCameraStatusListener(new OnBackCameraStatusListener() { // from class: com.hzbhd.canbus.car._36.UiMgr.5
            @Override // com.hzbhd.canbus.interfaces.OnBackCameraStatusListener
            public void addViewToWindows() {
                boolean boolValue = SharePreUtil.getBoolValue(context, "_36_is_back_camera", false);
                boolean boolValue2 = SharePreUtil.getBoolValue(context, "_36_is_panoramic", false);
    ...
    /* renamed from: com.hzbhd.canbus.car._36.UiMgr$6, reason: invalid class name */
