...
public class UiMgr extends AbstractUiMgr {
    ...
    OnPanoramicItemTouchListener mOnPanoramicItemTouchListener = new OnPanoramicItemTouchListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.3
    ...
    OnPanoramicItemClickListener mOnPanoramicItemClickListener = new OnPanoramicItemClickListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.4
    ...
    OnSettingItemSeekbarSelectListener mOnSettingItemSeekbarSelectListener = new OnSettingItemSeekbarSelectListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.5
    ...
    OnSettingItemSelectListener mOnSettingItemSelectListener = new OnSettingItemSelectListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.6
        ...
        public void onClickItem(int i, int i2, int i3) {
            ...
            if (i == uiMgr2.getSettingLeftIndexes(uiMgr2.mContext, "_306_360")) {
                ...
                if (i2 == uiMgr6.getSettingRightIndex(uiMgr6.mContext, "_306_360", "_306_avm_switch")) {
                    Context context = UiMgr.this.mContext;
                    UiMgr uiMgr7 = UiMgr.this;
                    SharePreUtil.setIntValue(context, uiMgr7.getMsgMgr(uiMgr7.mContext).ID306_AVM_CONGIF_TAG, i3);
                    UiMgr uiMgr8 = UiMgr.this;
                    uiMgr8.getMsgMgr(uiMgr8.mContext).updateSettings(i, i2, i3);
                }
            }
            UiMgr uiMgr9 = UiMgr.this;
            if (i == uiMgr9.getSettingLeftIndexes(uiMgr9.mContext, "_306_voice_language")) {
                UiMgr uiMgr10 = UiMgr.this;
                if (i2 == uiMgr10.getSettingRightIndex(uiMgr10.mContext, "_306_voice_language", "_306_voice_language")) {
                    if (i3 == 0) {
                        UiMgr uiMgr11 = UiMgr.this;
                        uiMgr11.getMsgMgr(uiMgr11.mContext);
                        MsgMgr.mLanguage = "_zh";
                    } else {
                        UiMgr uiMgr12 = UiMgr.this;
                        uiMgr12.getMsgMgr(uiMgr12.mContext);
                    ...
                    uiMgr13.getMsgMgr(uiMgr13.mContext).updateSettings(i, i2, SharePreUtil.getIntValue(UiMgr.this.mContext, "ID383_VOICE_LANGUAGE", 0));
                }
            }
        }
    };
    OnAirWindSpeedUpDownClickListener mOnAirWindSpeedUpDownClickListenerFront = new OnAirWindSpeedUpDownClickListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.7
    ...
    OnAirTemperatureUpDownClickListener mOnUpDownClickListenerFrontLeft = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.8
    ...
    OnAirTemperatureUpDownClickListener mOnUpDownClickListenerFrontRight = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.9
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirTemperatureUpDownClickListener
        public void onClickUp() {
    ...
    OnAirBtnClickListener mOnAirBtnClickListenerFrontTop = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.10
    ...
    OnAirBtnClickListener mOnAirBtnClickListenerFronteft = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.11
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            if (i != 0) {
                return;
    ...
    OnAirBtnClickListener mOnAirBtnClickListenerFrontRight = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.12
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            if (i != 0) {
                return;
    ...
    OnAirBtnClickListener mOnAirBtnClickListenerFrontBottom = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.13
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            if (i == 0) {
    ...
    public UiMgr(Context context) {
        ...
        airUiSet.getFrontArea().setOnAirPageStatusListener(new OnAirPageStatusListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.1
            @Override // com.hzbhd.canbus.adapter.interfaces.OnAirPageStatusListener
            public void onStatusChange(int i) {
                CanbusMsgSender.sendMsg(new byte[]{22, -112, 40});
            }
        });
        airUiSet.getFrontArea().setOnAirSeatClickListener(new OnAirSeatClickListener() { // from class: com.hzbhd.canbus.car._383.UiMgr.2
        ...
        this.mParkPageUiSet.setOnPanoramicItemTouchListener(new OnPanoramicItemTouchListener() { // from class: com.hzbhd.canbus.car._383.UiMgr$$ExternalSyntheticLambda0
            @Override // com.hzbhd.canbus.interfaces.OnPanoramicItemTouchListener
    ...
    private void intiUi() {
        ...
        int settingLeftIndexes = getSettingLeftIndexes(this.mContext, "_306_360");
        int settingRightIndex = getSettingRightIndex(this.mContext, "_306_360", "_306_avm_switch");
        Context context = this.mContext;
        msgMgr.updateSettings(settingLeftIndexes, settingRightIndex, SharePreUtil.getIntValue(context, getMsgMgr(context).ID306_AVM_CONGIF_TAG, 0));
    }
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [com.hzbhd.canbus.car._383.UiMgr$14] */
    public void sendAirCmd(final int i) {
        new Thread() { // from class: com.hzbhd.canbus.car._383.UiMgr.14
