...
public class MsgMgr extends AbstractMsgMgr {
    ...
    private void initAmplifierData(Context context) {
        ...
        timerUtil.startTimer(new TimerTask() { // from class: com.hzbhd.canbus.car._158.MsgMgr.1
    ...
    public void afterServiceNormalSetting(final Context context) {
        ...
        this.mHandler = new Handler(Looper.getMainLooper()) { // from class: com.hzbhd.canbus.car._158.MsgMgr.2
    ...
    private void set0x21AirData(Context context) {
        if (GeneralAirData.climate != DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[6])) {
            ...
            } else if (SystemUtil.isForeground(context, AirActivity.class.getName())) {
                finishActivity();
            }
        }
        ...
        bArr[7] = 0;
        bArr[9] = (byte) (bArr[9] & 239);
        if (isAirDataChange(bArr)) {
            int airWhat = getAirWhat();
            GeneralAirData.auto_manual = DataHandleUtils.getBoolBit1(this.mAirData[6]);
            GeneralAirData.fahrenheit_celsius = DataHandleUtils.getBoolBit0(this.mAirData[6]);
            GeneralAirData.power = DataHandleUtils.getBoolBit7(this.mAirData[2]);
            GeneralAirData.ac = DataHandleUtils.getBoolBit6(this.mAirData[2]);
            GeneralAirData.in_out_cycle = true ^ DataHandleUtils.getBoolBit5(this.mAirData[2]);
            GeneralAirData.sync = DataHandleUtils.getBoolBit4(this.mAirData[2]);
            GeneralAirData.auto = DataHandleUtils.getBoolBit3(this.mAirData[2]);
            GeneralAirData.dual = DataHandleUtils.getBoolBit2(this.mAirData[2]);
            GeneralAirData.rear_defog = DataHandleUtils.getBoolBit1(this.mAirData[2]);
            GeneralAirData.rear = DataHandleUtils.getBoolBit0(this.mAirData[2]);
            GeneralAirData.front_left_blow_window = DataHandleUtils.getBoolBit7(this.mAirData[3]);
            GeneralAirData.front_left_blow_head = DataHandleUtils.getBoolBit6(this.mAirData[3]);
            GeneralAirData.front_left_blow_foot = DataHandleUtils.getBoolBit5(this.mAirData[3]);
            ...
            GeneralAirData.front_wind_level = DataHandleUtils.getIntFromByteWithBit(this.mAirData[3], 0, 4);
            GeneralAirData.front_left_temperature = resolveAirTemperature(context, this.mAirData[4] & 255);
            GeneralAirData.front_right_temperature = resolveAirTemperature(context, this.mAirData[5] & 255);
            GeneralAirData.front_defog = DataHandleUtils.getBoolBit7(this.mAirData[6]);
            GeneralAirData.rear_power = DataHandleUtils.getBoolBit2(this.mAirData[6]);
            GeneralAirData.rear_temperature = resolveAirTemperature(context, this.mAirData[8] & 255);
            GeneralAirData.rear_left_blow_window = DataHandleUtils.getBoolBit7(this.mAirData[9]);
            GeneralAirData.rear_left_blow_head = DataHandleUtils.getBoolBit6(this.mAirData[9]);
            GeneralAirData.rear_left_blow_foot = DataHandleUtils.getBoolBit5(this.mAirData[9]);
            ...
            GeneralAirData.rear_wind_level = DataHandleUtils.getIntFromByteWithBit(this.mAirData[9], 0, 4);
            GeneralAirData.rear_auto = DataHandleUtils.getBoolBit7(this.mAirData[10]);
            GeneralAirData.front_left_seat_cold_level = DataHandleUtils.getIntFromByteWithBit(this.mAirData[11], 6, 2);
            GeneralAirData.front_left_seat_heat_level = DataHandleUtils.getIntFromByteWithBit(this.mAirData[11], 4, 2);
            GeneralAirData.front_right_seat_cold_level = DataHandleUtils.getIntFromByteWithBit(this.mAirData[11], 2, 2);
            GeneralAirData.front_right_seat_heat_level = DataHandleUtils.getIntFromByteWithBit(this.mAirData[11], 0, 2);
    ...
    private void set0x32VehicleSettingData() {
        updateOutDoorTemp(this.mContext, (DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 0, 4) - 5) + "LEVEL");
        if (isDataChange(this.mCanBusInfoInt)) {
            ArrayList arrayList = new ArrayList();
        ...
        if ("original_status_radio".equals(this.mOriginalStatus)) {
            if (isDataChange(this.mCanBusInfoInt)) {
                ...
                if (boolBit7) {
                    ...
                    this.mFmStorageArray[this.mCanBusInfoInt[4] + 1] = new SongListEntity("\t" + str + "\t" + ((mCanBusInfoInt[6] | (mCanBusInfoInt[5] << 8)) / 10.0f) + " MHz");
    ...
    /* JADX WARN: Type inference failed for: r0v5, types: [com.hzbhd.canbus.car._158.MsgMgr$3] */
    /* JADX WARN: Type inference failed for: r0v6, types: [com.hzbhd.canbus.car._158.MsgMgr$4] */
        ...
        if (isDataChange(this.mCanBusInfoInt)) {
            ...
            switch (i) {
                case 32:
                    ...
                    new CountDownTimer(500L, 100L) { // from class: com.hzbhd.canbus.car._158.MsgMgr.3
                ...
                case 33:
                    realKeyClick(context, 129);
                    new CountDownTimer(500L, 100L) { // from class: com.hzbhd.canbus.car._158.MsgMgr.4
                        @Override // android.os.CountDownTimer
                        public void onTick(long j) {
                        }
    ...
    public void showDialog(Context context, String str, String str2, String str3, String str4) {
        ...
        this.EXIT.setOnClickListener(new View.OnClickListener() { // from class: com.hzbhd.canbus.car._158.MsgMgr.5
    ...
    public boolean customLongClick(Context context, int i) {
        ...
        realKeyClick(context, HotKeyConstant.K_SPEECH);
        return true;
    }
    ...
    private boolean isAirDataChange(byte[] bArr) {
        CommUtil.printHexStringByTag("_157_MsgMgr", "isAirDataChange income: ", bArr);
        for (int i = 2; i < bArr.length; i++) {
            byte[] bArr2 = this.mAirData;
            if (bArr2[i] != bArr[i]) {
                System.arraycopy(bArr, 2, bArr2, 2, bArr.length - 2);
                CommUtil.printHexStringByTag("_157_MsgMgr", "isAirDataChange saved: ", this.mAirData);
                return true;
            }
        }
        return false;
    ...
    private boolean isPreCameraOrAuxForeground(Context context) {
        return SystemUtil.isForeground(context, new String[]{HzbhdComponentName.PreCameraMainActivity.getClassName(), HzbhdComponentName.AuxMainActivity.getClassName()});
    }
