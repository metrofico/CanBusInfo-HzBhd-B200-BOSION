...
public class RadarView extends RelativeLayout {
    ...
    public RadarView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout._442_md_radar_view, this);
        this.rear_left_line = (ImageView) findViewById(R.id.rear_left_line);
        this.rear_mid_left_line = (ImageView) findViewById(R.id.rear_mid_left_line);
        this.rear_mid_right_line = (ImageView) findViewById(R.id.rear_mid_right_line);
    ...
    public void refreshRadar() {
        ...
        if (MdRadarData.left_mid_rear == 0) {
            this.rear_mid_left_line.setBackgroundResource(R.drawable._441_radar_null2);
        } else if (MdRadarData.left_mid_rear == 1) {
            this.rear_mid_left_line.setBackgroundResource(R.drawable._441_radar_rear_left1);
        } else if (MdRadarData.left_mid_rear == 2) {
            this.rear_mid_left_line.setBackgroundResource(R.drawable._441_radar_rear_left2);
        } else if (MdRadarData.left_mid_rear == 3) {
            this.rear_mid_left_line.setBackgroundResource(R.drawable._441_radar_rear_left3);
        }
        if (MdRadarData.right_mid_rear == 0) {
            this.rear_mid_right_line.setBackgroundResource(R.drawable._441_radar_null2);
        } else if (MdRadarData.right_mid_rear == 1) {
            this.rear_mid_right_line.setBackgroundResource(R.drawable._441_radar_rear_right1);
        } else if (MdRadarData.right_mid_rear == 2) {
            this.rear_mid_right_line.setBackgroundResource(R.drawable._441_radar_rear_right2);
        } else if (MdRadarData.right_mid_rear == 3) {
            this.rear_mid_right_line.setBackgroundResource(R.drawable._441_radar_rear_right3);
        }
