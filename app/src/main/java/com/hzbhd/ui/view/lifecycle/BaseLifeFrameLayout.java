...
public class BaseLifeFrameLayout extends FrameLayout implements LifecycleOwner {
    ...
    public void addOrRemoveView() {
        BaseUtil.INSTANCE.runUi(new Function0<Unit>() { // from class: com.hzbhd.ui.view.lifecycle.BaseLifeFrameLayout.addOrRemoveView.1
            {
                super(0);
            }
