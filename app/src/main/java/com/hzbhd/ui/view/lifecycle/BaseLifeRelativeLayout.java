    ...
    public void addOrRemoveView() {
        BaseUtil.INSTANCE.runUi(new Runnable() {
            ...
            public void run() {
                ...
                if (BaseLifeRelativeLayout.this.isAttachedToWindow() && BaseLifeRelativeLayout.this.getWindowVisibility() == View.VISIBLE && BaseLifeRelativeLayout.this.getVisibility() == View.VISIBLE && BaseLifeRelativeLayout.this.getMVisibility() == 0 && BaseLifeRelativeLayout.this.getMWindowVisibility() == 0) {
