...
public class BaseLifeRelativeLayout extends RelativeLayout implements LifecycleOwner {
    ...
    public void addOrRemoveView() {
        BaseUtil.INSTANCE.runUi(new Function0<Unit>() { // from class: com.hzbhd.ui.view.lifecycle.BaseLifeRelativeLayout.addOrRemoveView.1
            {
                super(0);
            }
