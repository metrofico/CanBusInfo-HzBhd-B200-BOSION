...
public class MsgMgr extends AbstractMsgMgr {
                    ...
                    switch (i) {
                        ...
                        case 56:
                            if (SharePreUtil.getIntValue(this.mContext, this.ID306_AVM_CONGIF_TAG, 0) == 0) {
                                runOnUi(new AbstractMsgMgr.CallBackInterface() { // from class: com.hzbhd.canbus.car._383.MsgMgr.1
    ...
    public void showDialogAndRestartApp(final String str) {
        runOnUi(new AbstractMsgMgr.CallBackInterface() { // from class: com.hzbhd.canbus.car._383.MsgMgr.2
            @Override // com.hzbhd.canbus.msg_mgr.AbstractMsgMgr.CallBackInterface
            public void callback() {
                new SetAlertView().showDialog(MsgMgr.this.getActivity(), str);
                new CountDownTimer(3000L, 1000L) { // from class: com.hzbhd.canbus.car._383.MsgMgr.2.1
