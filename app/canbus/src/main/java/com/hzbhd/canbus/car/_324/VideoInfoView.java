...
public class VideoInfoView extends LinearLayout {
    ...
    public VideoInfoView(Context context, AttributeSet attributeSet, int i) {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(R.layout.__324_view_video_info, (ViewGroup) this, true);
    ...
    public void startVideoView() {
        ...
        textureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() { // from class: com.hzbhd.canbus.car._324.VideoInfoView.1
