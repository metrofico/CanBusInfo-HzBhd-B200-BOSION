...
public class MessageSender {
    ...
    public static void saveCommonSwitch(int[] iArr) {
        ...
        SharePreUtil.setStringValue(mContext, MsgMgr.SAVE_COMMON_SWITCH, sb.toString());
    }

    public static String getCommonSwitch() {
        return SharePreUtil.getStringValue(mContext, MsgMgr.SAVE_COMMON_SWITCH, "");
    }
    ...
    private void saveCanBusInfo(int[] iArr, int i) {
        ...
        LogUtil.showLog(sb.toString());
        if (i == 1) {
            SharePreUtil.setStringValue(mContext, MsgMgr.SAVE_AIRINFO_1, sb.toString());
        } else if (i == 2) {
            SharePreUtil.setStringValue(mContext, MsgMgr.SAVE_AIRINFO_2, sb.toString());
        }
    }
