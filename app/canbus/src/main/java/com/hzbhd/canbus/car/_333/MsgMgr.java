...
public class MsgMgr extends AbstractMsgMgr {
    ...
    private void initAmplifier(Context context) {
        ...
        timerUtil.startTimer(new TimerTask() { // from class: com.hzbhd.canbus.car._333.MsgMgr.1
            final Iterator<byte[]> iterator = Arrays.stream(new byte[][]{new byte[]{22, -127, 1}, new byte[]{22, -124, 1, 1}, new byte[]{22, -124, 3, (byte) ((-GeneralAmplifierData.frontRear) + 10)}, new byte[]{22, -124, 4, (byte) (GeneralAmplifierData.leftRight + 10)}, new byte[]{22, -124, 6, (byte) (GeneralAmplifierData.bandTreble + 3)}, new byte[]{22, -124, 5, (byte) (GeneralAmplifierData.bandBass + 3)}, new byte[]{22, -124, 10, 1}}).iterator();
    ...
    private void setAmplifierInfo0x17(Context context) {
        ArrayList arrayList = new ArrayList();
    ...
    private void setCarState0x38() {
        ...
        arrayList.add(new SettingUpdateEntity(leftIndexes, 28, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[8], 7, 1))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, 29, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[8], 5, 2))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, 30, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[8], 4, 1))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, 31, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[8], 3, 1))));
        arrayList.add(new SettingUpdateEntity(leftIndexes, 32, Integer.valueOf(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[8], 2, 1))));
        updateGeneralSettingData(arrayList);
        updateSettingActivity(null);
        int[] iArr = this.mCanBusInfoInt;
        iArr[3] = 0;
    ...
    private void showDialog(final String str) {
        runOnUi(new AbstractMsgMgr.CallBackInterface() { // from class: com.hzbhd.canbus.car._333.MsgMgr.2
