...
public class UiMgr extends AbstractUiMgr {
    ...
    OnAirBtnClickListener mOnAirBtnClickListenerFrontTop = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._22.UiMgr.6
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            UiMgr.this.resolveAirBtn(0, i);
        }
    };
    OnAirBtnClickListener mOnAirBtnClickListenerFronteft = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._22.UiMgr.7
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            UiMgr.this.resolveAirBtn(1, i);
        }
    };
    OnAirBtnClickListener mOnAirBtnClickListenerFrontRight = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._22.UiMgr.8
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            UiMgr.this.resolveAirBtn(2, i);
        }
    };
    OnAirBtnClickListener mOnAirBtnClickListenerFrontBottom = new OnAirBtnClickListener() { // from class: com.hzbhd.canbus.car._22.UiMgr.9
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirBtnClickListener
        public void onClickItem(int i) {
            UiMgr.this.resolveAirBtn(3, i);
        }
    };
    OnAirTemperatureUpDownClickListener mOnUpDownClickListenerFrontLeft = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._22.UiMgr.10
    ...
    OnAirTemperatureUpDownClickListener mOnUpDownClickListenerFrontRight = new OnAirTemperatureUpDownClickListener() { // from class: com.hzbhd.canbus.car._22.UiMgr.11
        @Override // com.hzbhd.canbus.adapter.interfaces.OnAirTemperatureUpDownClickListener
        public void onClickUp() {
    ...
    public UiMgr(final Context context) {
        ...
        airUiSet.getFrontArea().setSetWindSpeedViewOnClickListener(new OnAirWindSpeedUpDownClickListener() { // from class: com.hzbhd.canbus.car._22.UiMgr.1
        ...
        airUiSet.getFrontArea().setOnAirSeatClickListener(new OnAirSeatClickListener() { // from class: com.hzbhd.canbus.car._22.UiMgr.2
        ...
        getMsgMgr(context).updateSetting(0, 0, SharePreUtil.getIntValue(context, "share_22_language", 0));
        getMsgMgr(context).updateSetting(1, 0, SharePreUtil.getBoolValue(context, SHARE_22_IS_SUPPORT_PANORAMIC, false) ? 1 : 0);
        final SettingPageUiSet settingUiSet = getSettingUiSet(context);
        settingUiSet.setOnSettingItemSelectListener(new OnSettingItemSelectListener() { // from class: com.hzbhd.canbus.car._22.UiMgr.3
            @Override // com.hzbhd.canbus.interfaces.OnSettingItemSelectListener
            public void onClickItem(int i, int i2, int i3) {
                if (i == 0) {
                    if (i2 == 0) {
                        CanbusMsgSender.sendMsg(new byte[]{22, -125, 49, (byte) i3});
                        SharePreUtil.setIntValue(UiMgr.this.mContext, "share_22_language", i3);
                ...
                if (i == 1 && i2 == 0) {
                    SharePreUtil.setBoolValue(context, UiMgr.SHARE_22_IS_SUPPORT_PANORAMIC, i3 == 1);
                    UiMgr.this.getMsgMgr(context).updateSetting(i, i2, i3);
                }
            }
        });
        settingUiSet.setOnSettingItemTouchListener(new OnSettingItemTouchListener() { // from class: com.hzbhd.canbus.car._22.UiMgr.4
        ...
        parkPageUiSet.setOnBackCameraStatusListener(new OnBackCameraStatusListener() { // from class: com.hzbhd.canbus.car._22.UiMgr.5
            @Override // com.hzbhd.canbus.interfaces.OnBackCameraStatusListener
            public void addViewToWindows() {
                boolean boolValue = SharePreUtil.getBoolValue(context, UiMgr.SHARE_22_IS_SUPPORT_PANORAMIC, false);
    ...
    private void sendUpDownCommand(byte[] bArr, final byte[] bArr2, long j) {
        ...
        startTimer(new TimerTask() { // from class: com.hzbhd.canbus.car._22.UiMgr.12
