...
public class MsgMgr extends AbstractMsgMgr {
    ...
    public void afterServiceNormalSetting(final Context context) {
        ...
        timerUtil.startTimer(new TimerTask() { // from class: com.hzbhd.canbus.car._60.MsgMgr.1
    ...
    private void startPhoneInfoTimer(byte[] bArr) {
        ...
        this.mPhoneInfoTimer.startTimer(new TimerTask() { // from class: com.hzbhd.canbus.car._60.MsgMgr.2
            @Override // java.util.TimerTask, java.lang.Runnable
            public void run() {
