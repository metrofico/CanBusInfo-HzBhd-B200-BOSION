...
public class MainActivity extends AbstractBaseActivity implements MainLvAdapter.ItemClickInterface, View.OnClickListener {
    ...
    private void findViews() {
        ...
        this.mDebugLayout = (LinearLayout) findViewById(R.id.ll_debug);
        this.mTvNoCanTips = (TextView) findViewById(R.id.tv_no_can_tips);
    }
    ...
    private void initViews() {
        ...
        if (com.hzbhd.util.LogUtil.log5()) {
            com.hzbhd.util.LogUtil.d("initViews(): ----" + ((CanSettingProxy) Dependency.get(CanSettingProxy.class)).getCanSettingShow());
        }
    ...
    public void onItemClick(int i) {
        ...
        switch (action) {
            case "original_car_device":
                startActivity(new Intent(this, (Class<?>) OriginalCarDeviceActivity.class));
                break;
            case "mqb_hybrid":
                startActivity(new Intent(this, (Class<?>) MqbHybirdActivity.class));
                break;
            case "general_settings":
                startActivity(new Intent(this, (Class<?>) FactoryActivity.class));
                break;
            case "panel_key":
                startActivity(new Intent(this, (Class<?>) PanelKeyActivity.class));
                break;
            case "hybird":
                startActivity(new Intent(this, (Class<?>) HybirdActivity.class));
                break;
            case "air":
            ...
            case "warning":
                ...
                break;
            case "amplifier":
                startActivity(new Intent(this, (Class<?>) AmplifierActivity.class));
                break;
            case "on_start":
                startActivity(new Intent(this, (Class<?>) OnStarActivity.class));
                break;
            case "setting":
    ...
    public void onClick(View view) {
        ...
        startActivity(new Intent(this, (Class<?>) SelectCanTypeActivity.class));
    }
}
