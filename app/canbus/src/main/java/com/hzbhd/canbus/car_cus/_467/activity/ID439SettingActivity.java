...
public class ID439SettingActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (ScreenConfig.screenWidth == 1024 && ScreenConfig.screenHeight == 600) {
            setContentView(R.layout.activity_id467_setting1024x600);
        } else {
            setContentView(R.layout.activity_id467_setting1280x720);
        }
        ...
        textView.setOnTouchListener(new View.OnTouchListener() { // from class: com.hzbhd.canbus.car_cus._467.activity.ID439SettingActivity.1
        ...
        textView2.setOnTouchListener(new View.OnTouchListener() { // from class: com.hzbhd.canbus.car_cus._467.activity.ID439SettingActivity.2
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0) {
        ...
        textView3.setOnTouchListener(new View.OnTouchListener() { // from class: com.hzbhd.canbus.car_cus._467.activity.ID439SettingActivity.3
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0) {
        ...
        textView4.setOnTouchListener(new View.OnTouchListener() { // from class: com.hzbhd.canbus.car_cus._467.activity.ID439SettingActivity.4
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0) {
